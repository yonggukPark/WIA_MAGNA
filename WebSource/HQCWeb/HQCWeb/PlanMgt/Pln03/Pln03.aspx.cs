...
namespace HQCWeb.PlanMgt.Pln03
{
    public partial class Pln03 : System.Web.UI.Page
    {
        ...
        // 비지니스 클래스 작성
        Biz.PlanManagement.Pln03 biz = new Biz.PlanManagement.Pln03();
        ...
        private void SetCon()
        {
            ...
            //DDL 작성 
            strDBName = "GPDB";
            strQueryID = "Pln03Data.Get_DdlData";
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                {
                    ddlPlanCd.Items.Add(new ListItem(ds.Tables[0].Rows[i]["CODE_NM"].ToString(), ds.Tables[0].Rows[i]["CODE_ID"].ToString()));
                }
            }
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Pln03");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Pln03");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "CAR_TYPE", "PART_NO", "PART_DESC", "PLAN_NM", "Q1", "Q2", "Q3", "Q4", "Q5", "Q6", "Q7", "KEY_HID" };
                        ...
                        {
                            arrColumnCaption[i] = Dictionary_Data.SearchDic(arrColumn[i].ToString(), bp.g_language);
                            arrColumnWidth[i] = (i>6) ? "100" : ( (i>1) ? "130" : "100" );
                        }
                    }
                }
            }
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Pln03Data.Get_PlanList";
            ...
            sParam.Add("CUR_MENU_ID", "Pln03");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            logParam.Add("CUR_MENU_ID", "Pln03");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요

            btnlog.SetCUD(strDBName, "ButtonStatisticsData.Set_ButtonHisInfo", logParam);// 버튼로그 저장

            // 비지니스 메서드 호출
            ds = biz.GetWeekPlan(strDBName, strQueryID, sParam);
