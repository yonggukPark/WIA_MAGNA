        ...
        function settingGrid(_val) {
            ...
            gridView.onCellClicked = function (grid, clickData) {
                ...
                if (clickData.column == 'SHIP_NO') {
                    ...
                    if (dataProvider.getValue(current.dataRow, current.column) != "") {
            ...
            const f = function (grid, dataCell) {
                var ret = {}
                var StatusFlg = grid.getValue(dataCell.index.itemIndex, "STATUS_FLG")
            ...
            gridView.columnByName("TRANS_FLG").styleCallback = f;
            ...
            gridView.columnByName("PLAN_QTY").styleCallback = f3;
            gridView.columnByName("DELIVERY_QTY").styleCallback = f3;
        ...
        <div class="search_grid mt13">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td colspan = "3">
                        <asp:UpdatePanel runat="server" ID="UpdatePanel2" UpdateMode="Conditional">
                            <ContentTemplate>
                                <div class="searchCombo" style="width:440px; font-size:12px;">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlStatus" runat="server" Width="250"></asp:DropDownList>
                    </td>
                    <td class="al-r">
                       <%-- <asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click" OnClientClick="javascript:fn_Validation();" Visible="false" />
                        <input type="button" value="Excel" id="btnExcel" runat="server" visible="false" onclick="fn_excelExport('Pln04'); return false;" />--%>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtShipNo" runat="server" Width="270" ></asp:TextBox></td>
                    <th><asp:Label ID="lbCustomerCd" runat="server"></asp:Label></th>
                    <td>
                        <asp:DropDownList ID="ddlCustomerCd" runat="server" Width="250" ></asp:DropDownList>
                    </td>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlSubStorageCd" runat="server" Width="250"></asp:DropDownList>
                    </td>
                        ...
                        <tr>
                            <td>
                                <div class="toolbar">
                                    ...
                                    <input type="button" value="Set" id="btnSet" onclick="getCol('Pln04'); return false;" style="display:none; margin-top:10px; float:left" />
