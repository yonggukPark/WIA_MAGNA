...
namespace HQCWeb.PlanMgt.Pln04
{
    public partial class Pln04_p02 : System.Web.UI.Page
    {
        ...
        protected void btnModify_Click(object sender, EventArgs e)
        {
            ...
            string param = cy.Encrypt(strPlantCd + "/" + strShipNo + "/" + bp.g_userid.ToString() + "/" + ddlShipOutType.SelectedItem.Text + "/" + txtPrintReason.Value.ToString());
            strScript = $@" cPrint = {jsDdl1}; fn_Set_Print(); ";
