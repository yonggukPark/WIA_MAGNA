...
namespace HQCWeb.ResultMgt.PlnWidget02
{
    public partial class PlnWidget02 : System.Web.UI.Page
    {
        ...
        //비즈니스 선언
        Biz.PlanManagement.PlnWidget02 biz = new Biz.PlanManagement.PlnWidget02();
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PART_NO" };
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "PlnWidget02");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "PlnWidget02");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "PLAN_DATE", "PLAN_ORDER_NO", "TRANS_FLG", "PART_NO", "PART_DESC", "S_STORAGE_NM", "D_STORAGE_NM", "PLAN_QTY", "DELIVERY_QTY", "RATIO", "STATUS_FLG", "KEY_HID" };
                        ...
                        arrColumnWidth[0] = "40";
                        arrColumnWidth[1] = "80";
                        arrColumnWidth[2] = "110";
                        arrColumnWidth[3] = "100";
                        arrColumnWidth[4] = "90";
                        arrColumnWidth[5] = "200";
                        arrColumnWidth[6] = "140";
                        arrColumnWidth[7] = "140";
                        arrColumnWidth[8] = "125";
                        arrColumnWidth[9] = "125";
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "PlnWidgetData.Get_PlanList_Widget_Pop";

            FW.Data.Parameters sParam = new FW.Data.Parameters();
            sParam.Add("PLANT_CD", bp.g_plant.ToString());

            sParam.Add("CUR_MENU_ID", "PlnWidget02");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            logParam.Add("CUR_MENU_ID", "PlnWidget02");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
