<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Pln11_p01.aspx.cs" Inherits="HQCWeb.PlanMgt.Pln11.Pln11_P01" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PopupContent" runat="server">
    ...
    <div class="popup_wrap">
        <!--// Title -->
        <div class="title">
            <h1><asp:Label ID="lbTitle" runat="server">Pln11</asp:Label> - <asp:Label ID="lbWorkName" runat="server"></asp:Label></h1>
