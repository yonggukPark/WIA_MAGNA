...
namespace HQCWeb.ResultMgt.ResComm
{
    public partial class ResComm : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "SHOP_CD", "COMPLETE_NO", "B" };
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "ResComm");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "ResComm");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "PROD_DT", "RPT_DATE", "ORDER_NO", "PLAN_CD", "PLAN_DETAIL_CD", "SHOP_CD", "LINE_CD", "CAR_TYPE", "PART_NO", "COMPLETE_NO", "SERIAL_NO", "KEY_HID" };
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "ResCommData.Get_List";
            ...
            sParam.Add("PROD_DT", strSplitValue[4].ToString());

            sParam.Add("CUR_MENU_ID", "ResComm");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            logParam.Add("CUR_MENU_ID", "ResComm");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
