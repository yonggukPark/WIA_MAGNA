...
{
    public partial class Res12 : System.Web.UI.Page
    {
        ...
        // 비지니스 클래스 작성
        Biz.ResultManagement.Res12 biz = new Biz.ResultManagement.Res12();
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "P_SHOP_CD", "LINE_CD", "PART_NO" };
        //JSON 전달용 변수
        ...
        private void SetCon()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                {
                    ddlDayNight.Items.Add(new ListItem(ds.Tables[5].Rows[i]["CODE_NM"].ToString(), ds.Tables[5].Rows[i]["CODE_ID"].ToString()));
                }
                for (int i = 0; i < ds.Tables[6].Rows.Count; i++)
                {
                    ddlYear.Items.Add(new ListItem(ds.Tables[6].Rows[i]["CODE_NM"].ToString(), ds.Tables[6].Rows[i]["CODE_ID"].ToString()));
                }
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Res12");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Res12");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_NM", "PART_NO", "PLAN_NM", "PLAN_DETAIL_NM", "DIVISION", "PLAN_SUM", "PLAN_MON01", "PLAN_MON02", "PLAN_MON03", "PLAN_MON04", "PLAN_MON05", "PLAN_MON06", "PLAN_MON07", "PLAN_MON08", "PLAN_MON09", "PLAN_MON10", "PLAN_MON11", "PLAN_MON12", "PROD_DT", "LINE_CD", "P_SHOP_CD", "KEY_HID" };
        ...
        {
            lbProdDt.Text = Dictionary_Data.SearchDic("PROD_YEAR", bp.g_language);
        ...
        public void GetData()
        {
            ...
            logParam.Add("CUR_MENU_ID", "Res12");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
