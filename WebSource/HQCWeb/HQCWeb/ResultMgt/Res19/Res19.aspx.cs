...
namespace HQCWeb.ResultMgt.Res19
{
    public partial class Res19 : System.Web.UI.Page
    {
        ...
        // 비지니스 클래스 작성
        Biz.ResultManagement.Res19 biz = new Biz.ResultManagement.Res19();
        ...
        private void SetCon()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Res19Data.Get_DdlData";
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                {
                    ddlYear.Items.Add(new ListItem(ds.Tables[2].Rows[i]["CODE_NM"].ToString(), ds.Tables[2].Rows[i]["CODE_ID"].ToString()));
                }
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Res19");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Res19");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "LINE_NM", "STN_CD", "SUM_PROD", "PROD_MONTH01", "PROD_MONTH02", "PROD_MONTH03", "PROD_MONTH04", "PROD_MONTH05", "PROD_MONTH06", "PROD_MONTH07", "PROD_MONTH08", "PROD_MONTH09", "PROD_MONTH10", "PROD_MONTH11", "PROD_MONTH12", "KEY_HID" };
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Res19Data.Get_ProdList";
            ...
            sParam.Add("PROD_DT", ddlYear.SelectedValue);

            sParam.Add("CUR_MENU_ID", "Res19");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            logParam.Add("CUR_MENU_ID", "Res19");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
