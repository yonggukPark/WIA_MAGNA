...
namespace HQCWeb.ResultMgt.Res20
{
    public partial class Res20 : System.Web.UI.Page
    {
        ...
        // 비지니스 클래스 작성
        Biz.ResultManagement.Res20 biz = new Biz.ResultManagement.Res20();
        ...
        private void SetCon()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Res20Data.Get_DdlData";
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Res20");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Res20");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "LINE_NM", "STN_CD", "SUM_PROD", "PROD_HOUR00", "PROD_HOUR01", "PROD_HOUR02", "PROD_HOUR03", "PROD_HOUR04", "PROD_HOUR05", "PROD_HOUR06", "PROD_HOUR07", "PROD_HOUR08", "PROD_HOUR09", "PROD_HOUR10", "PROD_HOUR11", "PROD_HOUR12", "PROD_HOUR13", "PROD_HOUR14", "PROD_HOUR15", "PROD_HOUR16", "PROD_HOUR17", "PROD_HOUR18", "PROD_HOUR19", "PROD_HOUR20", "PROD_HOUR21", "PROD_HOUR22", "PROD_HOUR23", "KEY_HID" };
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Res20Data.Get_ProdList";
            ...
            sParam.Add("CUR_MENU_ID", "Res20");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            logParam.Add("CUR_MENU_ID", "Res20");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
