...
namespace HQCWeb.ResultMgt.Res27
{
    public partial class Res27 : System.Web.UI.Page
    {
        ...
        // 비지니스 클래스 작성
        Biz.ResultManagement.Res27 biz = new Biz.ResultManagement.Res27();
        ...
        private void SetCon()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Res27Data.Get_DdlData";
            jsData2 = "[]";
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Res27");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Res27");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "PART_NO", "DIVISION", "PLAN_SUM", "PLAN_MON01", "PLAN_MON02", "PLAN_MON03", "PLAN_MON04", "PLAN_MON05", "PLAN_MON06", "PLAN_MON07", "PLAN_MON08", "PLAN_MON09", "PLAN_MON10", "PLAN_MON11", "PLAN_MON12", "PROD_DT", "KEY_HID" };
                        ...
                        arrColumnWidth[8] = "78";
                        arrColumnWidth[9] = "78";
                        arrColumnWidth[10] = "78";
                        arrColumnWidth[11] = "78";
                        arrColumnWidth[12] = "78";
                        arrColumnWidth[13] = "78";
                        arrColumnWidth[14] = "78";
                        arrColumnWidth[15] = "78";
                        arrColumnWidth[16] = "0";
                        arrColumnWidth[17] = "0";
                    }
                }
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Res27Data.Get_ProdList";
            ...
            sParam.Add("CUR_MENU_ID", "Res27");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            logParam.Add("CUR_MENU_ID", "Res27");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
