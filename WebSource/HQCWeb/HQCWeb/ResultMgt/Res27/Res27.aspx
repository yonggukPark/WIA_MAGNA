<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Res27.aspx.cs" Inherits="HQCWeb.ResultMgt.Res27.Res27" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fn_Popup(pkCode) {
            fn_PostOpenPop(pkCode, '/ResultMgt/ResComm2/ResComm2.aspx', "1600", "750");
        }
        ...
        function createGrid(_val) {
            ...
            field.forEach(item => {
                if (item.fieldName == 'PLAN_SUM' || item.fieldName.substring(0, 8) == 'PLAN_MON') {
        ...
        function settingGrid(_val) {
            ...
            gridView.onCellClicked = function (grid, clickData) {
                ...
                if (clickData.column.substring(0, 8) == 'PLAN_MON' || clickData.column == 'PLAN_SUM') {
                    ...
                    if (division == '실적수량') {
                        if (dataProvider.getValue(current.dataRow, current.column) > 0) {
                            ...
                            var seq = dataProvider.getValue(current.dataRow, "PROD_DT") + ((clickData.column.substring(0, 8) == 'PLAN_MON') ? clickData.column.substring(8, 10) : '');
                            fn_Chk(value, seq);
                        }
                        else {
                            alert("데이터가 없습니다.");
            ...
            gridView.setRowStyleCallback(function (grid, item, fixed) {
                ...
                var partNo = grid.getValue(item.index, "PART_NO");
            ...
            for (var i = 0; i < 12; i++) {
                gridView.columnByName("PLAN_MON" + (i+1).toString().padStart(2, '0')).styleName = "number-column";
            }
    ...
    <div class="contents" tabindex="0">
        <!--// Title + Win_Btn -->
        <div class="title">
            <h3><asp:Label ID="lbTitle" runat="server">Res27</asp:Label></h3>
            <div class="al-r">
                <asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click" OnClientClick="fn_WatingCall();" Visible="false" />
                <input type="button" value="Excel" id="btnExcel" runat="server" visible="false" onclick="fn_excelExport('Res27'); return false;" />
            </div>
        </div>
        <!-- Title + Win_Btn //-->
        <!--// Grid Search -->
                        ...
                        <tr>
                            <td>
                                <div class="toolbar">
                                    ...
                                    <input type="button" value="Set" id="btnSet" onclick="getCol('Res27'); return false;" style="display:none; margin-top:10px; float:left" />
