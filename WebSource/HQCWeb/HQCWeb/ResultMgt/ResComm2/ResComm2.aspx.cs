...
namespace HQCWeb.ResultMgt.ResComm2
{
    public partial class ResComm2 : System.Web.UI.Page
    {
        ...
        //비즈니스 선언
        Biz.ResultManagement.ResComm2 biz = new Biz.ResultManagement.ResComm2();
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "SHOP_CD", "COMPLETENO", "B" };
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "ResComm2");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "ResComm2");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "PLAN_DATE", "SHIP_DATE", "PLAN_ORDER_NO", "PALLET_NO", "PALLET_MAP_NO", "COMPLETENO", "PART_NO", "PART_DESC", "S_STORAGE_NM", "D_STORAGE_NM", "CUSTOMER_NM", "KEY_HID" };
                        ...
                        arrColumnWidth[0] = "40";
                        arrColumnWidth[1] = "76";
                        arrColumnWidth[2] = "111";
                        arrColumnWidth[3] = "111";
                        arrColumnWidth[4] = "84";
                        arrColumnWidth[5] = "148";
                        arrColumnWidth[6] = "151";
                        arrColumnWidth[7] = "90";
                        arrColumnWidth[8] = "200";
                        arrColumnWidth[9] = "150";
                        arrColumnWidth[10] = "150";
                        arrColumnWidth[11] = "150";
                        arrColumnWidth[12] = "0";
                    }
                }
            }
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "ResComm2Data.Get_List";
            ...
            sParam.Add("PART_NO", strSplitValue[1].ToString());
            sParam.Add("PROD_DT", strSplitValue[2].ToString());

            sParam.Add("CUR_MENU_ID", "ResComm2");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            logParam.Add("CUR_MENU_ID", "ResComm2");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
        ...
        public static string GetMenu(string sMenu, string sData)
        {
            ...
            string sendData = cy.Encrypt(decrpted + "/B");//바코드
