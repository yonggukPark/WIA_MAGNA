...
namespace HQCWeb.ResultMgt.ResWidget02
{
    public partial class ResWidget02 : System.Web.UI.Page
    {
        ...
        //비즈니스 선언
        Biz.ResultManagement.ResWidget02 biz = new Biz.ResultManagement.ResWidget02();
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "ResWidget02");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "ResWidget02");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "LINE_CD", "PART_NO", "PART_DESC", "PLAN_QTY", "RES_QTY", "RATIO", "KEY_HID" };
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "ResWidgetData.Get_BSAList_Widget_Pop";

            FW.Data.Parameters sParam = new FW.Data.Parameters();
            sParam.Add("PLANT_CD", bp.g_plant.ToString());

            sParam.Add("CUR_MENU_ID", "ResWidget02");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            logParam.Add("CUR_MENU_ID", "ResWidget02");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
