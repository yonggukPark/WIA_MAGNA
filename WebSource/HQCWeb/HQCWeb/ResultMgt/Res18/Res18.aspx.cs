    ...
    public partial class Res18 : System.Web.UI.Page
    {
        ...
        private void SetCon()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                {
                    ddlMonth.Items.Add(new ListItem(ds.Tables[3].Rows[i]["CODE_NM"].ToString(), ds.Tables[3].Rows[i]["CODE_ID"].ToString()));
                }
        ...
        public void GetData()
        {
            ...
            logParam.Add("CUR_MENU_ID", "Res18");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
