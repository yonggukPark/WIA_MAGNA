...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function settingGrid(_val) {
            ...
            var j = getDate($("#MainContent_ddlYear").val() + $("#MainContent_ddlMonth").val());
            ...
            for (var i = 0; i < j; i++)
                gridView.columnByName("PROD_DAY" + String(i+1).padStart(2, '0')).styleName = "number-column";
                        ...
                        <tr>
                            <td>
                                <div class="toolbar">
                                    ...
                                    <input type="button" value="Set" id="btnSet" onclick="getCol('Res18'); return false;" style="display:none; margin-top:10px; float:left" />
