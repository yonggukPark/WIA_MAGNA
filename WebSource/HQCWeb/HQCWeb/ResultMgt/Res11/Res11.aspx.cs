...
namespace HQCWeb.ResultMgt.Res11
{
    public partial class Res11 : System.Web.UI.Page
    {
        ...
        // 비지니스 클래스 작성
        Biz.ResultManagement.Res11 biz = new Biz.ResultManagement.Res11();
        ...
        private void SetCon()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Res11Data.Get_DdlData";
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                {
                    ddlMonth.Items.Add(new ListItem(ds.Tables[7].Rows[i]["CODE_NM"].ToString(), ds.Tables[7].Rows[i]["CODE_ID"].ToString()));
                }
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Res11");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Res11");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_NM", "PART_NO", "PLAN_NM", "PLAN_DETAIL_NM", "DIVISION", "PLAN_SUM", "PLAN_DAY01", "PLAN_DAY02", "PLAN_DAY03", "PLAN_DAY04", "PLAN_DAY05", "PLAN_DAY06", "PLAN_DAY07", "PLAN_DAY08", "PLAN_DAY09", "PLAN_DAY10", "PLAN_DAY11", "PLAN_DAY12", "PLAN_DAY13", "PLAN_DAY14", "PLAN_DAY15", "PLAN_DAY16", "PLAN_DAY17", "PLAN_DAY18", "PLAN_DAY19", "PLAN_DAY20", "PLAN_DAY21", "PLAN_DAY22", "PLAN_DAY23", "PLAN_DAY24", "PLAN_DAY25", "PLAN_DAY26", "PLAN_DAY27", "PLAN_DAY28", "PLAN_DAY29", "PLAN_DAY30", "PLAN_DAY31", "PROD_DT", "LINE_CD", "P_SHOP_CD", "KEY_HID" };
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Res11Data.Get_ProdList";
            ...
            sParam.Add("CUR_MENU_ID", "Res11");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            logParam.Add("CUR_MENU_ID", "Res11");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
