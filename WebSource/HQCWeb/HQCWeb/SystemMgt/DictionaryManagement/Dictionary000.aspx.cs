...
{
    public partial class Dictionary000 : System.Web.UI.Page
    {
        ...
        private void SetPageInit()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "DIC_ID", "DIC_TXT_KR", "DIC_TXT_EN", "DIC_TXT_LO", "REGIST_DATE", "REGIST_USER_ID", "MODIFY_DATE", "MODIFY_USER_ID", "KEY_HID" };
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "DictionaryData.Get_DictionaryList";

            FW.Data.Parameters sParam = new FW.Data.Parameters();
            sParam.Add("DIC_ID",        txtDictionaryID.Text);
            sParam.Add("DIC_NM",        txtDictionaryNM.Text);
            ...
            logParam.Add("CUR_MENU_ID", "WEB_00020");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요

            btnlog.SetCUD(strDBName, "ButtonStatisticsData.Set_ButtonHisInfo", logParam);// 버튼로그 저장

            // 데이터 바인딩
            ds = biz.GetDictionaryList(strDBName, strQueryID, sParam);
