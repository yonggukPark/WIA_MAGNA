<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Dictionary000.aspx.cs" Inherits="HQCWeb.SystemMgt.DictionaryManagement.Dictionary000" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <script type="text/javascript">
        function fn_Register() {
            fn_OpenPop('/SystemMgt/DictionaryManagement/Dictionary001.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
        }

        function fn_Modify(pkCode) {
            fn_PostOpenPop(pkCode, '/SystemMgt/DictionaryManagement/Dictionary002.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
        }
        ...
        function settingGrid(_val) {
            ...
            gridView.columnByName("DIC_TXT_KR").styleName = "string-column"
            gridView.columnByName("DIC_TXT_EN").styleName = "string-column"
            gridView.columnByName("DIC_TXT_LO").styleName = "string-column"
    ...
    <div class="contents" tabindex="0">
        <!--// Title + Win_Btn -->
        <div class="title">
            <h3><asp:Label ID="lbTitle" runat="server">WEB_00020</asp:Label></h3>
        </div>
        <!--// Grid Search -->
        <div class="search_grid mt13">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <th><asp:Label ID="lbDictionaryNM" runat="server"></asp:Label></th>
                        ...
                        <tr>
                            <td>
                                <div class="toolbar">
                                    ...
                                    <input type="button" value="Set" id="btnSet" onclick="getCol('WEB_00020'); return false;" style="display:none; margin-top:10px; float:left" />
