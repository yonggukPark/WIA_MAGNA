...
{
    public partial class Menu000 : System.Web.UI.Page
    {
        ...
        private void SetPageInit()
        {
            ...
            if (ds.Tables.Count > 0) {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "MENU_ID", "MENU_NM", "MENU_PARENT_ID", "MENU_LEVEL", "MENU_IDX", "REGIST_DATE", "REGIST_USER_ID", "MODIFY_DATE", "MODIFY_USER_ID", "ASSEMBLY_ID", "VIEW_ID", "USE_YN", "POPUP_YN", "APPROVAL_FLAG", "KEY_HID" };
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "MenuData.Get_MenuList";

            FW.Data.Parameters param = new FW.Data.Parameters();
            param.Add("MENU_ID",        txtMenuID.Text);
            ...
            logParam.Add("CUR_MENU_ID", "WEB_00010");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요

            btnlog.SetCUD(strDBName, "ButtonStatisticsData.Set_ButtonHisInfo", logParam);// 버튼로그 저장

            // 데이터 바인딩
            ds = biz.GetMenuList(strDBName, strQueryID, param);
