...
{
    public partial class Button000 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "BUTTON_ID" };
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID",       "WEB_00080");
            sParam.Add("USER_ID",       bp.g_userid.ToString());
            
            sParam.Add("CUR_MENU_ID",   "WEB_00080");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "BUTTON_ID", "BUTTON_TXT_KR", "BUTTON_TXT_EN", "BUTTON_TXT_LO", "BUTTON_FUNCTION", "BUTTON_IDX", "USE_YN", "REGIST_DATE", "REGIST_USER_ID", "MODIFY_DATE", "MODIFY_USER_ID", "KEY_HID" };
        ...
        private void SetTitle()
        {
            ...
            lbButtonNM.Text = Dictionary_Data.SearchDic("BUTTON_NM", bp.g_language);
        }
        #endregion
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "ButtonData.Get_ButtonList";

            FW.Data.Parameters sParam = new FW.Data.Parameters();
            sParam.Add("BUTTON_ID", txtButtonID.Text);
            sParam.Add("BUTTON_NM", txtButtonNM.Text);
            ...
            logParam.Add("CUR_MENU_ID", "WEB_00080");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
