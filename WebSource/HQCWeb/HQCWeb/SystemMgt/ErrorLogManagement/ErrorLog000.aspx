<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="ErrorLog000.aspx.cs" Inherits="HQCWeb.SystemMgt.ErrorLogManagement.ErrorLog000" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        function fn_Modify(pkCode) {
            fn_PostOpenPop(pkCode, '/SystemMgt/ErrorLogManagement/ErrorLog001.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
        }
        ...
        function settingGrid(_val) {
            ...
            gridView.columnByName("ERROR_NO").styleName = "grid-primary-column"
    ...
    <div class="contents" tabindex="0">
        <!--// Title + Win_Btn -->
        <div class="title">
            <h3><asp:Label ID="lbTitle" runat="server">WEB_00070</asp:Label></h3>
        </div>
        <!-- Title + Win_Btn //-->
        <!--// Grid Search -->
                        ...
                        <tr>
                            <td>
                                <div class="toolbar">
                                    ...
                                    <input type="button" value="Set" id="btnSet" onclick="getCol('WEB_00070'); return false;" style="display:none; margin-top:10px; float:left" />
