<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="ErrorLog001.aspx.cs" Inherits="HQCWeb.SystemMgt.ErrorLogManagement.ErrorLog001" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PopupContent" runat="server">
	<!--// POPUP -->
    <div class="popup_wrap" tabindex="0">
        <!--// Title -->
        <div class="title">
            <h1><asp:Label ID="lbTitle" runat="server">WEB_00070</asp:Label> - <asp:Label ID="lbWorkName" runat="server"></asp:Label></h1>
