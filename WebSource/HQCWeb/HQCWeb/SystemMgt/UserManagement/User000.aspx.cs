...
{
    public partial class User000 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "USER_ID" };
        //JSON 전달용 변수
        ...
        private void SetPageInit()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "USER_CONVERT_ID", "USER_NM", "USER_GROUP", "SITE_ID", "USER_DEPT", "USER_TEL", "USER_MOBILE", "USER_EMAIL", "USER_EXPIRE_CNT", "PASSWORD_EXPIRE_CNT", "REGIST_DATE", "REGIST_USER_ID", "MODIFY_DATE", "MODIFY_USER_ID", "USER_ID", "KEY_HID" };
        ...
        public void GetData()
        {
            ...
            // 조회 서비스 클래스 작성
            Biz.SystemManagement.UserMgt sp = new Biz.SystemManagement.UserMgt();
            ...
            param.Add("USER_NM",        txtUserNM.Text);
            
            param.Add("CUR_MENU_ID",    "WEB_00040");
            ...
            logParam.Add("CUR_MENU_ID", "WEB_00040");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요

            btnlog.SetCUD(strDBName, "ButtonStatisticsData.Set_ButtonHisInfo", logParam);// 버튼로그 저장

            // 데이터 바인딩
            ds = sp.GetUserInfoList(strDBName, strQueryID, param);
