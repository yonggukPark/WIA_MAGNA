...
{
    public partial class Message000 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "MSG_ID" };
        //JSON 전달용 변수
        ...
        private void SetPageInit()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "MSG_ID", "MSG_TXT_KR", "MSG_TXT_EN", "MSG_TXT_LO", "REGIST_DATE", "REGIST_USER_ID", "MODIFY_DATE", "MODIFY_USER_ID", "KEY_HID" };
        ...
        private void SetTitle()
        {
            ...
            lbMessageNM.Text = Dictionary_Data.SearchDic("MSG_NM", bp.g_language);
        }
        #endregion
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "MessageData.Get_MessageList";

            FW.Data.Parameters sParam = new FW.Data.Parameters();
            sParam.Add("MSG_ID",        txtMessageID.Text);
            sParam.Add("MSG_NM",        txtMessageNM.Text);
            sParam.Add("CUR_MENU_ID",   "WEB_00030");
            ...
            logParam.Add("CUR_MENU_ID", "WEB_00030");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요

            btnlog.SetCUD(strDBName, "ButtonStatisticsData.Set_ButtonHisInfo", logParam);// 버튼로그 저장

            // 데이터 바인딩
            ds = biz.GetMessageList(strDBName, strQueryID, sParam);
