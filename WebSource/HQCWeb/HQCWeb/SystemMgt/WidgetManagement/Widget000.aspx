...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        function fn_Modify(pkCode) {
            fn_PostOpenPop(pkCode, '/SystemMgt/WidgetManagement/Widget002.aspx', $("#MainContent_hidWidth").val(), "350");
        }
    ...
    <asp:HiddenField ID="hidHeight" runat="server" Value="310" />
                        ...
                        <tr>
                            <td>
                                <div class="toolbar">
                                    ...
                                    <input type="button" value="Set" id="btnSet" onclick="getCol('WEB_00110'); return false;" style="display:none; margin-top:10px; float:left" />
