...
{
    public partial class AuthGroup000 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "AUTHGROUP_ID" };
        ...
        private void SetPageInit()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "AUTHGROUP_ID", "AUTHGROUP_TXT_KR", "AUTHGROUP_TXT_EN", "AUTHGROUP_TXT_LO", "USE_YN", "REGIST_DATE", "REGIST_USER_ID", "MODIFY_DATE", "MODIFY_USER_ID", "KEY_HID"  };
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "AuthGroupData.Get_AuthGroupList";

            FW.Data.Parameters sParam = new FW.Data.Parameters();
            sParam.Add("AUTHGROUP_ID", "");
            sParam.Add("AUTHGROUP_NM", "");
            ...
            // 비지니스 메서드 호출
            ds = biz.GetAuthGroupList(strDBName, strQueryID, sParam);
