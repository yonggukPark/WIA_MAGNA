        ...
        function fn_AddRtn(_vals) {
            ...
            for (var j = 0; j < arrUserInfo.length; j++) {
                ...
                for (var i = 0; i < _rowCnt; i++) {
                    _userID = $("#tbList tbody tr:eq(" + i + ")>td:eq(4)").html();
                ...
                if (iChk == "1") {
                    ...
                    _ValText += "   <td style=\"padding:0px;text-align:left;\">" + arrUserData[4] + "</td>"; 
                    _ValText += "   <td style=\"padding:0px;text-align:left;\">" + arrUserData[1] + "</td>"; 
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                         <div class="btn_wrap" style="margin-bottom:10px !important; padding-right:15px; margin-top: 5px;">
                             <a href="javascript:fn_Add();" class="btn ml10" >Add</a>  <%--style="display:none;"--%>
