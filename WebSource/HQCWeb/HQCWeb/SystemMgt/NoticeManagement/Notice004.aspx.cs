...
{
    public partial class Notice004 : System.Web.UI.Page
    {
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("WEB_00101", "WEB_00101");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "NOTICE_NUM", "NOTICE_TITLE", "NOTICE_USER", "NOTICE_DATE", "KEY_HID" };
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "NoticeData.Get_NoticeList2";

            FW.Data.Parameters sParam = new FW.Data.Parameters();
            sParam.Add("NOTICE_SEARCH_TXT", txtSearchTxt.Text);

            sParam.Add("CUR_MENU_ID", "WEB_00101");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
