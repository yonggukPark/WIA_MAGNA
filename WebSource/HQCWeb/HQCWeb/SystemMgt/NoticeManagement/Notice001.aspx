            ...
            if (_vFileChk == 1) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    if (extension == "png" || extension == "gif" || extension == "jpg") {
                        ...
                        alert("첨부할 수 없는 확장자입니다. 다른 파일을 선택하시기 바랍니다.");
                    ...
                    _ValText += "   <td><img src=\"/images/btn/delete.png\" style=\"width:15px;height:15px;padding-bottom:2px;\" onclick=\"javascript:fn_fileDel('" + _vFname + "', '" + extension + "');\" /></td>";
