<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Notice004.aspx.cs" Inherits="HQCWeb.SystemMgt.NoticeManagement.Notice004" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">

        function fn_View(pkCode) {
            fn_PostOpenPop(pkCode, '/SystemMgt/NoticeManagement/Notice005.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
        }
    ...
    <div class="contents" tabindex="0">
        <!--// Title + Win_Btn -->
        <div class="title">
            <h3><asp:Label ID="lbTitle" runat="server">WEB_00101</asp:Label></h3>
        </div>
        <!-- Title + Win_Btn //-->
        <!--// Grid Search -->
                        ...
                        <tr>
                            <td>
                                <div class="toolbar">
                                    ...
                                    <input type="button" value="Set" id="btnSet" onclick="getCol('WEB_00101'); return false;" style="display:none; margin-top:10px; float:left" />
