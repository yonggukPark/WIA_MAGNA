...
{
    public partial class Notice000 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "NOTICE_NUM" };
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("WEB_00100",     "WEB_00100");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "NOTICE_NUM", "NOTICE_TITLE", "USE_YN", "REGIST_DATE", "REGIST_USER_ID", "MODIFY_DATE", "MODIFY_USER_ID", "NOTICE_VIEW", "KEY_HID" };
        ...
        {
            lbSearchTxt.Text = Dictionary_Data.SearchDic("SEARCH_TXT", bp.g_language);
        }
        #endregion
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "NoticeData.Get_NoticeList";

            FW.Data.Parameters sParam = new FW.Data.Parameters();
            sParam.Add("NOTICE_SEARCH_TXT",     txtSearchTxt.Text);
            ...
            logParam.Add("CUR_MENU_ID", "WEB_00100");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
