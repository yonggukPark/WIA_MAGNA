<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Notice005.aspx.cs" Inherits="HQCWeb.SystemMgt.NoticeManagement.Notice005" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PopupContent" runat="server">
    ...
    <div class="popup_wrap" tabindex="0">
        <!--// Title -->
        <div class="title">
            <h1><asp:Label ID="lbTitle" runat="server">WEB_00101</asp:Label> - <asp:Label ID="lbWorkName" runat="server"></asp:Label></h1>
