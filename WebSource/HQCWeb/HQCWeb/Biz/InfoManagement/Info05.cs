...
namespace HQCWeb.Biz.InfoManagement
{
    public class Info05
    {
        ...
        #region GetPartList
        public DataSet GetPartList(string strDBName, string strQueryID, Parameters sParam)
        {
        ...
        #region GetPartNoValChk
        public string GetPartNoValChk(string strDBName, string strQueryID, Parameters sParam)
        {
