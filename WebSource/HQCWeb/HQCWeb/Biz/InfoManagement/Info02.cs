...
namespace HQCWeb.Biz.InfoManagement
{
    public class Info02
    {
        ...
        #region GetCodeList
        public DataSet GetCodeList(string strDBName, string strQueryID, Parameters sParam)
        {
        ...
        #region GetCodeValChk
        public string GetCodeValChk(string strDBName, string strQueryID, Parameters sParam)
        {
