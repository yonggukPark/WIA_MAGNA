...
{
    public partial class Spc02 : System.Web.UI.Page
    {
        ...
        // 비지니스 클래스 작성
        Biz.SpcManagement.Spc02 biz = new Biz.SpcManagement.Spc02();
        ...
        private void SetCon()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Spc02Data.Get_DdlData";
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Spc02");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Spc02");
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Spc02Data.Get_SpcListChk";
            ...
            sParamChk.Add("CUR_MENU_ID", "Spc02");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            logParam.Add("CUR_MENU_ID", "Spc02");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    if ( ds.Tables[0].Rows.Count > 0 && ds.Tables[0].Rows[0]["AVG_ITEM"].ToString() != string.Empty && ds.Tables[0].Rows[0]["MIN_ITEM"].ToString() != string.Empty && ds.Tables[0].Rows[0]["H"].ToString() != string.Empty )
                    {
                        ...
                        strDBName = "GPDB";
                        strQueryID = "Spc02Data.Get_SpcList";
                        ...
                        sParam.Add("CUR_MENU_ID", "Spc02");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
                        ...
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            ...
                            if (!String.IsNullOrEmpty(jsData))
                            {
                                ...
                                string script = $@" chartData = {jsData}; resetChart();";
