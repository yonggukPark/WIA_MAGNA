...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        function createDetailGrid(_val) {
            ...
            gridView2.setColumns(column);
            dataProvider2.setFields(field);
        ...
        function settingDetailGrid(_val) {
            ...
            gridView2.columnByName("COL_1").styleName = "grid-primary-column"
                        ...
                        <tr>
                            <td>
                                <div class="toolbar">
                                    ...
                                    <input type="button" value="Set" id="btnSet2" onclick="getCol2('MENU_ID'); return false;" style="display:none;" />
                                </div>
                            </td>
                        </tr>
                    </table>
