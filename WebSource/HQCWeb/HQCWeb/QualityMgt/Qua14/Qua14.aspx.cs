...
{
    public partial class Qua14 : System.Web.UI.Page
    {
        ...
        // 비지니스 클래스 작성
        Biz.QualityManagement.Qua14 biz = new Biz.QualityManagement.Qua14();
        ...
        private void SetCon()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Qua14Data.Get_DdlData";
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Qua14");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Qua14");
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Qua14Data.Get_Inspection";
            ...
            sParam.Add("CUR_MENU_ID", "Qua14");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            logParam.Add("CUR_MENU_ID", "Qua14");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        sParam2.Add("MENU_ID", "Qua14_" + menuAdd);
                        sParam2.Add("USER_ID", bp.g_userid.ToString());

                        sParam2.Add("CUR_MENU_ID", "Qua14");
