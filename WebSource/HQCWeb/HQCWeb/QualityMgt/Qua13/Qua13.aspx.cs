...
{
    public partial class Qua13 : System.Web.UI.Page
    {
        ...
        // 비지니스 클래스 작성
        Biz.QualityManagement.Qua13 biz = new Biz.QualityManagement.Qua13();
        ...
        private void SetCon()
        {
            ...
            ddlPset.Items.Add(new ListItem("선택하세요", ""));
            ddlEopFlag.Items.Add(new ListItem("ALL", ""));

            strDBName = "GPDB";
            strQueryID = "Qua13Data.Get_DdlData";
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                {
                    ddlPset.Items.Add(new ListItem(ds.Tables[4].Rows[i]["CODE_NM"].ToString(), ds.Tables[4].Rows[i]["CODE_ID"].ToString()));
                }
                ...
                {
                    ddlCarType.Items.Add(new ListItem(ds.Tables[6].Rows[i]["CODE_NM"].ToString(), ds.Tables[6].Rows[i]["CODE_ID"].ToString()));
                }
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Qua13");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Qua13");
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Qua13Data.Get_TorqueList";
            ...
            sParam.Add("P_SET", ddlPset.SelectedValue);

            sParam.Add("CUR_MENU_ID", "Qua13");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            logParam.Add("CUR_MENU_ID", "Qua13");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        jsData3 = ConvertJSONData.ConvertDataTableToJSON2(ds.Tables[2]);

                        //정상처리되면
                        //if (!String.IsNullOrEmpty(jsData))
                        if (!String.IsNullOrEmpty(jsData2))
                        {
                            ...
                            string script = $@" chartData1 = {jsData}; chartData2 = {jsData2}; chartData3 = {jsData3}; resetChart();";
                    ...
                    else
                    {
                        ...
                        string script = $@" chartData1 = ''; chartData2 = ''; chartData3 = ''; resetChart(); ";
