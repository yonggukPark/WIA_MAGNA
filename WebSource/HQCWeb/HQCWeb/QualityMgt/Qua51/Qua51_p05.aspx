<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Qua51_p05.aspx.cs" Inherits="HQCWeb.QualityMgt.Qua51.Qua51_p05" %>
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lbGetCertNo" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
        ...
        function fn_fileDel(_val, _val2, _val3, _val4, _val5) {
            if (_val3 == "P") {
                if (confirm("서버에 업로드된 파일을 삭제합니다. 삭제처리된 파일은 되돌릴수 없습니다. 삭제 하시겠습니까?")) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "Qua51_p05.aspx/SetFileInfoDel",
                        data: jsonData,
