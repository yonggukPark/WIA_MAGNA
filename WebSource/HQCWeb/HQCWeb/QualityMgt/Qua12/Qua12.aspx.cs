    ...
    public partial class Qua12 : System.Web.UI.Page
    {
        ...
        private void SetCon()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                {
                    ddlEopFlag.Items.Add(new ListItem(ds.Tables[6].Rows[i]["CODE_NM"].ToString(), ds.Tables[6].Rows[i]["CODE_ID"].ToString()));
                }
            }
        ...
        private void SetTitle()
        {
            ...
            lbProdDt.Text = Dictionary_Data.SearchDic("MODI_DATE", bp.g_language);//20240604 수정요청
        }
        #endregion
        ...
        public void GetData()
        {
            ...
            logParam.Add("CUR_MENU_ID", "Qua12");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        sParam2.Add("MENU_ID", "Qua12_" + menuAdd);
