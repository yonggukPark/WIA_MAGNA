...
{
    public partial class Qua40_p01 : System.Web.UI.Page
    {
        ...
        {
            // 수정 또는 삭제
            lbWorkName.Text = Dictionary_Data.SearchDic("DIFF_HI", bp.g_language)+" "+Dictionary_Data.SearchDic("DETAIL", bp.g_language); // 상세
        ...
        protected void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Qua40Data.Get_DiffInfo";
            ...
            sParam.Add("WORK_FLAG", strSplitValue[9].ToString());
        ...
        protected void btnModify_Click(object sender, EventArgs e)
        {
            ...
            {
                strDBName = "GPDB";
                strQueryID = "Qua40Data.Get_DiffID_ValChk";
                ...
                if (ds.Tables.Count > 0)
                {
                    ...
                    {
                        strDBName = "GPDB";
                        strQueryID = "Qua40Data.Set_DiffInfo";
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Qua40Data.Del_DiffInfo";
        ...
        protected void btnRestore_Click(object sender, EventArgs e)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Qua40Data.Restore_DiffInfo";
            ...
            if (iRtn == 1)
            {
                ...
                strScript = " alert('정상복원 되었습니다.');  parent.fn_ModalReloadCall('Qua40'); parent.fn_ModalCloseDiv(); ";
                ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
            }
            else
            {
