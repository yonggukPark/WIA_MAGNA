<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Qua50_p02.aspx.cs" Inherits="HQCWeb.QualityMgt.Qua50.Qua50_p02" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PopupContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fn_ModifyConfirm() {
            if ($("#PopupContent_ddlCarType").val() == "") {
                alert("차종을 선택하세요.");
                return false;
            } else {
    ...
    <div class="popup_wrap">
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <th><asp:Label ID="lbRegDt" runat="server"></asp:Label></th>
                    <td>
                        <asp:Label ID="lbGetRegDt" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th><asp:Label ID="lbInboundDt" runat="server"></asp:Label></th>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtCompleteNo" runat="server" MaxLength="30"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <th><asp:Label ID="lbAttachFile" runat="server"></asp:Label></th>
                    <td style="padding-left:10px;">
                        <asp:FileUpload ID="fuUpload" runat="server" AllowMultiple="true" accept=".gif,.png,.jpg,.ppt,.pptx,.xls,.xlsx,.pdf" style="display:none;"  onchange="onFileSelected();" />
        ...
        function fn_fileDel(_val, _val2, _val3, _val4, _val5) {
            if (_val3 == "P") {
                if (confirm("서버에 업로드된 파일을 삭제합니다. 삭제처리된 파일은 되돌릴수 없습니다. 삭제 하시겠습니까?")) {
                    ...
                    var jsonData = JSON.stringify({ sParams: _val4, sParams2: _val5, sParams3: vPath });

                    $.ajax({
                        type: "POST",
                        url: "Qua50_p02.aspx/SetFileInfoDel",
                        data: jsonData,
