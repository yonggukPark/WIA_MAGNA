...
{
    public partial class Qua24 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "STN_CD", "SERIAL_NO", "PART_SERIAL_NO", "RPT_DATE", "CAR_TYPE", "WORK_CD" };
        ...
        private void SetCon()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Qua24Data.Get_DdlData";
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Qua24");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Qua24");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SERIAL_NO", "COMPLETE_NO", "STN_CD", "STN_NM", "DIV", "WORK_NM", "PART_SERIAL_NO", "CAR_TYPE", "WORK_CD", "DIFF_MSG", "REG_DATE", "REG_USER", "SHOP_CD", "LINE_CD", "RPT_DATE", "KEY_HID" };
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Qua24Data.Get_DiffList";
            ...
            logParam.Add("CUR_MENU_ID", "Qua24");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요

            btnlog.SetCUD(strDBName, "ButtonStatisticsData.Set_ButtonHisInfo", logParam);// 버튼로그 저장

            // 비지니스 메서드 호출
            ds = biz.GetDiffList(strDBName, strQueryID, sParam);
