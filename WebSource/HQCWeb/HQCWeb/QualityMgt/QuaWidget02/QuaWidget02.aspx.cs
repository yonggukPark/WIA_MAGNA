...
namespace HQCWeb.ResultMgt.QuaWidget02
{
    public partial class QuaWidget02 : System.Web.UI.Page
    {
        ...
        //비즈니스 선언
        Biz.QualityManagement.QuaWidget02 biz = new Biz.QualityManagement.QuaWidget02();
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "QuaWidget02");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "QuaWidget02");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "DIVISION", "DEFECT_DT", "PART_NO", "PART_DESC", "LOT_NO", "DEFECT_CNT", "CONFIRM_USER", "KEY_HID" };
                        ...
                        arrColumnWidth[2] = "80";
                        arrColumnWidth[3] = "90";
                        arrColumnWidth[4] = "310";
                        arrColumnWidth[5] = "140";
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "QuaWidgetData.Get_DecomposeList_Widget_Pop";

            FW.Data.Parameters sParam = new FW.Data.Parameters();
            sParam.Add("PLANT_CD", bp.g_plant.ToString());

            sParam.Add("CUR_MENU_ID", "QuaWidget02");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            logParam.Add("CUR_MENU_ID", "QuaWidget02");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
