<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="QuaWidget02.aspx.cs" Inherits="HQCWeb.ResultMgt.QuaWidget02.QuaWidget02" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        function settingGrid(_val) {
            ...
            //9차_화면수정요청 : DIVISION 따라 색상변경
            const f = function (grid, dataCell) {
                var ret = {}
                var division = grid.getValue(dataCell.index.itemIndex, "DIVISION")
            ...
            gridView.columnByName("DIVISION").styleCallback = f;
    ...
    <div class="contents" tabindex="0">
        <!--// Title + Win_Btn -->
        <div class="title">
            <h3><asp:Label ID="lbTitle" runat="server">QuaWidget02</asp:Label></h3>
            <div class="al-r">
                <asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click" OnClientClick="fn_WatingCall();" Visible="false" />
                <input type="button" value="Excel" id="btnExcel" runat="server" visible="false" onclick="fn_excelExport('QuaWidget02'); return false;" />
                        ...
                        <tr>
                            <td>
                                <div class="toolbar">
                                    ...
                                    <input type="button" value="Set" id="btnSet" onclick="getCol('QuaWidget02'); return false;" style="display:none; margin-top:10px; float:left" />
