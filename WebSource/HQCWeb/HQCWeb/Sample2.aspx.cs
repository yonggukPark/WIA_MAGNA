...
namespace HQCWeb
{
    public partial class Sample2 : System.Web.UI.Page
    {
        ...
        {
            //IIS상의 가상 디렉토리 ppt로 접근 
            string strRtn = string.Empty;
            string strPath = "http://localhost:8089/ppt/" + sParams + "/";

            //strRtn = "<li><img src='"+ strPath + "ToImage-img-0.png' width='1280' height='300'></li>" +
            //    "<li><img src='" + strPath + "ToImage-img-1.png' width='1280' height='300'></li>" +
            //    "<li><img src='"+ strPath + "ToImage-img-2.png' width='1280' height='300'></li>" +
            //    "<li><img src='"+ strPath + "ToImage-img-3.png' width='1280' height='300'></li>" +
            //    "<li><img src='"+ strPath + "ToImage-img-4.png' width='1280' height='300'></li>" +
            //    "<li><img src='"+ strPath + "ToImage-img-5.png' width='1280' height='300'></li>" +
            //    "<li><img src='"+ strPath + "ToImage-img-6.png' width='1280' height='300'></li>" +
            //    "<li><img src='"+ strPath + "ToImage-img-7.png' width='1280' height='300'></li>" +
            //    "<li><img src='" + strPath + "ToImage-img-8.png' width='1280' height='300'></li>";
            ...
            if (sParams == "202401")
            {
                ...
                strRtn = "<li><img src='http://localhost:8089/ppt/202404/ToImage-img-0.png' width='1280' height='300'></li>" +
                "<li><img src='http://localhost:8089/ppt/202404/ToImage-img-1.png' width='1280' height='300'></li>" +
                "<li><img src='http://localhost:8089/ppt/202404/ToImage-img-2.png' width='1280' height='300'></li>" +
                "<li><img src='http://localhost:8089/ppt/202404/ToImage-img-3.png' width='1280' height='300'></li>" +
                "<li><img src='http://localhost:8089/ppt/202404/ToImage-img-4.png' width='1280' height='300'></li>" +
                "<li><img src='http://localhost:8089/ppt/202404/ToImage-img-5.png' width='1280' height='300'></li>" +
                "<li><img src='http://localhost:8089/ppt/202404/ToImage-img-6.png' width='1280' height='300'></li>" +
                "<li><img src='http://localhost:8089/ppt/202404/ToImage-img-7.png' width='1280' height='300'></li>" +
                "<li><img src='http://localhost:8089/ppt/202404/ToImage-img-8.png' width='1280' height='300'></li>";
            }
            else
            {
                strRtn = "<li><img src='http://localhost:8089/ppt/202404/ToImage-img-0.png' width='1280' height='300'></li>" +
