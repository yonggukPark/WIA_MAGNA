...
namespace HQCWeb.MonitorMgt.Mon10
{
    public partial class Mon10 : System.Web.UI.Page
    {
        ...
        // 비지니스 클래스 작성
        Biz.MonitorManagement.Mon10 biz = new Biz.MonitorManagement.Mon10();
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "SHOP_CD", "COMPLETE_NO"};
        ...
        private void SetCon()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Mon10Data.Get_DdlData";
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Mon10");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Mon10");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "PROD_DT", "PLAN_NM", "PLAN_DETAIL_NM", "ORDER_NO", "ORDER_TYPE", "RPT_DATE", "CAR_NM_KOR", "PART_NO", "SERIAL_NO", "COMPLETE_NO", "PRINT_CNT", "ORDER_TYPE_CD", "SHOP_CD", "LINE_CD", "CAR_TYPE", "KEY_HID" };
                        ...
                        arrColumnWidth[0] = "40";
                        arrColumnWidth[1] = "118";
                        arrColumnWidth[2] = "66";
                        arrColumnWidth[3] = "64";
                        arrColumnWidth[4] = "106";
                        arrColumnWidth[5] = "54";
                        arrColumnWidth[6] = "172";
                        arrColumnWidth[7] = "320";
                        arrColumnWidth[8] = "115";
                        arrColumnWidth[9] = "195";
                        arrColumnWidth[10] = "187";
                        arrColumnWidth[11] = "100";
                        arrColumnWidth[12] = "0";
                        arrColumnWidth[13] = "0";
                        arrColumnWidth[14] = "0";
                        arrColumnWidth[15] = "0";
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Mon10Data.Get_ProdList";
            ...
            sParam.Add("CUR_MENU_ID", "Mon10");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            logParam.Add("CUR_MENU_ID", "Mon10");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
