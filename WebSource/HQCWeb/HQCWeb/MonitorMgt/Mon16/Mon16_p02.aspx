<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Mon16_p02.aspx.cs" Inherits="HQCWeb.MonitorMgt.Mon16.Mon16_p02" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PopupContent" runat="server">
    ...
    <div class="popup_wrap">
        <!--// Title -->
        <div class="title">
            <h1><asp:Label ID="lbTitle" runat="server">Mon16</asp:Label> - <asp:Label ID="lbWorkName" runat="server"></asp:Label></h1>
