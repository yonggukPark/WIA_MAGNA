...
namespace HQCWeb.MonitorMgt.Mon16
{
    public partial class Mon16 : System.Web.UI.Page
    {
        ...
        Biz.MonitorManagement.Mon16 biz = new Biz.MonitorManagement.Mon16();
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "SHOP_CD", "P_LINE_CD", "SERIAL_NO" };
        ...
        private void SetCon()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Mon16Data.Get_DdlData";
            ...
            {
                jsDdl = ConvertJSONData.ConvertDataTableToJSON2(ds.Tables[1]);
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Mon16");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Mon16");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "SERIAL_NO", "COMPLETE_NO", "PROD_DT", "OUT_DATE", "BLOCK_FLAG", "REWORK_MSG", "RPT_DATE", "RPT_USER", "MOD_DATE", "MOD_USER", "BARCODE_FLAG", "KEY_HID" };
                        ...
                        arrColumnWidth[0] = "70";
                        arrColumnWidth[1] = "70";
                        arrColumnWidth[2] = "132";
                        arrColumnWidth[3] = "160";
                        arrColumnWidth[4] = "160";
                        arrColumnWidth[5] = "100";
                        arrColumnWidth[6] = "130";
                        arrColumnWidth[7] = "85";
                        arrColumnWidth[8] = "200";
                        arrColumnWidth[9] = "130";
                        arrColumnWidth[10] = "90";
                        arrColumnWidth[11] = "130";
                        arrColumnWidth[12] = "90";
                        arrColumnWidth[13] = "0";
                        arrColumnWidth[14] = "0";
                    }
                }
        ...
        private void SetTitle()
        {
            ...
            lbLockedData.Text = Dictionary_Data.SearchDic("LOCKED_DATA", bp.g_language);
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Mon16Data.Get_LockList";
            ...
            sParam.Add("P_FLAG", ((chkLockedData.Checked == true) ? "Y" : "N"));

            sParam.Add("CUR_MENU_ID", "Mon16");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            logParam.Add("CUR_MENU_ID", "Mon16");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
        ...
        {
            shopCd_SelectedIndexChanged();
        }
        #endregion

        #region shopCd_SelectedIndexChanged
        private void shopCd_SelectedIndexChanged()
        {
            //데이터셋 설정
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                {
                    jsData = ConvertJSONData.ConvertDataTableToJSON2(ds.Tables[1]);
                }
                //Stn Code 있으면
        ...
        #region txtLineCd_SelectedIndexChanged(사용안함)
