...
namespace HQCWeb.MonitorMgt.Mon17
{
    public partial class Mon17 : System.Web.UI.Page
    {
        ...
        // 비지니스 클래스 작성
        Biz.MonitorManagement.Mon17 biz = new Biz.MonitorManagement.Mon17();
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "STN_CD" };
        ...
        private void SetCon()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Mon17Data.Get_DdlData";
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Mon17");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Mon17");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "STN_CD", "STN_NM", "STATE_CD", "REMARK1", "REMARK2", "USE_YN", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "KEY_HID" };
                        ...
                        arrColumnWidth[2] = "41";
                        arrColumnWidth[3] = "46";
                        arrColumnWidth[4] = "192";
                        arrColumnWidth[5] = "116";
                        arrColumnWidth[6] = "200";
                        arrColumnWidth[7] = "200";
                        arrColumnWidth[8] = "54";
                        arrColumnWidth[9] = "130";
                        arrColumnWidth[10] = "140";
                        arrColumnWidth[11] = "130";
                        arrColumnWidth[12] = "140";
                        arrColumnWidth[13] = "0";
                    }
                }
            }
        ...
        private void SetTitle()
        {
            ...
            lbState.Text = Dictionary_Data.SearchDic("STATE_CD", bp.g_language);
        }
        #endregion
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Mon17Data.Get_OpStateList";
            ...
            param.Add("STATE_CD", ddlState.SelectedValue);

            // 조회이력 저장용 파라미터
            param.Add("CUR_MENU_ID", "Mon17");     // 조회페이지 메뉴 아이디 입력
            ...
            logParam.Add("CUR_MENU_ID", "Mon17");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
