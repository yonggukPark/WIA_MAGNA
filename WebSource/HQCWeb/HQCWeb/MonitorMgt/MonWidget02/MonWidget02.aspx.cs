...
namespace HQCWeb.MonultMgt.MonWidget02
{
    public partial class MonWidget02 : System.Web.UI.Page
    {
        ...
        //비즈니스 선언
        Biz.MonitorManagement.MonWidget02 biz = new Biz.MonitorManagement.MonWidget02();
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "LINE_CD", "PART_NO" };
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "MonWidget02");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "MonWidget02");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "STN_CD", "ALM_NO", "ALM_ADDR", "START_DATE", "END_DATE", "STOP_TIME", "ALM_MSG", "KEY_HID" };
                        ...
                        arrColumnWidth[0] = "40";
                        arrColumnWidth[1] = "42";
                        arrColumnWidth[2] = "119";
                        arrColumnWidth[3] = "200";
                        arrColumnWidth[4] = "104";
                        arrColumnWidth[5] = "141";
                        arrColumnWidth[6] = "129";
                        arrColumnWidth[7] = "129";
                        arrColumnWidth[8] = "110";
                        arrColumnWidth[9] = "533";
                        arrColumnWidth[10] = "0";
                    }
                }
            }
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "MonWidgetData.Get_AlarmList_Widget_Pop";

            FW.Data.Parameters sParam = new FW.Data.Parameters();
            sParam.Add("PLANT_CD", bp.g_plant.ToString());

            sParam.Add("CUR_MENU_ID", "MonWidget02");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            logParam.Add("CUR_MENU_ID", "MonWidget02");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
