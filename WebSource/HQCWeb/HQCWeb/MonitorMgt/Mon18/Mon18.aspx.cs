...
{
    public partial class Mon18 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "GUBUN_CD", "BARCODE" };
        ...
        private void SetCon()
        {
            ...
            ddlGubunCd.Items.Add(new ListItem("ALL", ""));
            ddlBlockFlag.Items.Add(new ListItem("ALL", ""));
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Mon18");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Mon18");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "GUBUN_CD", "BARCODE", "BLOCK_FLAG",  "REWORK_MSG", "RPT_DATE", "RPT_USER", "MOD_DATE", "MOD_USER", "KEY_HID" };
                        ...
                        arrColumnWidth[2] = "160";
                        arrColumnWidth[3] = "85";
                        arrColumnWidth[4] = "200";
                        arrColumnWidth[5] = "130";
                        arrColumnWidth[6] = "90";
                        arrColumnWidth[7] = "130";
                        arrColumnWidth[8] = "90";
                        arrColumnWidth[9] = "0";
                    }
                }
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Mon18Data.Get_LockList";
            ...
            sParam.Add("USE_YN", ddlBlockFlag.SelectedValue);
            ...
            logParam.Add("CUR_MENU_ID", "Mon18");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
