...
namespace HQCWeb.UserContorls
{
    public partial class TopControl : System.Web.UI.UserControl
    {
        ...
        protected void btnWCT_Click(object sender, EventArgs e)
        {
            string url = "https://wct.h-greenpower.co.kr/Login.html?id=" + bp.g_userid + "&factory=1217"; ; // 보호할 URL

            // ScriptManager로 JavaScript 함수 호출
            ScriptManager.RegisterStartupScript(Page, this.GetType(), "OpenWindow", $"openPopup('{url}');", true);
        }
    }
}