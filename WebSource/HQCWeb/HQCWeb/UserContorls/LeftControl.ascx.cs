                    ...
                    for (int j = 0; j < DT_ChildLevel.Rows.Count; j++)
                    {
                        ...
                        if (DT_ChildLevel.Rows[j]["MENU_LEVEL"].ToString() == "1")
                        {
                            ...
                            if (Convert.ToInt32(DT_ChildLevel.Rows[j]["CHILD_CNT"].ToString()) == 0)
                            {
                                strMenu += "<li>\n" +
                                                "<a href=\"#\" " +
                                                "onclick=\"fn_Add('" + strUrl + "', '" + strMenuName + "', '" + strMenuID + "', false);\" " +
                                                "ondblclick=\"fn_Add('" + strUrl + "', '" + strMenuName + "', '" + strMenuID + "', true);\">" +
                                                strMenuName + "</a>\n" +
                        ...
                        else if (DT_ChildLevel.Rows[j]["MENU_LEVEL"].ToString() == "2")
                        {
                            ...
                            if (Convert.ToInt32(DT_ChildLevel.Rows[j]["CHILD_CNT"].ToString()) == 0)
                            {
                                strMenu += "       <li>" +
                                                    "<a href=\"#\" " +
                                                    "onclick=\"fn_Add('" + strUrl + "', '" + strMenuName + "', '" + strMenuID + "', false);\" " +
                                                    "ondblclick=\"fn_Add('" + strUrl + "', '" + strMenuName + "', '" + strMenuID + "', true);\" id='a" + strMenuID + "'>" +
                                                    strMenuName + "</a>" +
                                                   //"<a href=\"javascript:fn_Add('" + strUrl + "','" + strMenuName + "','" + strMenuID + "');\" id='a" + strMenuID + "'>" + strMenuName + "</a>"+
                                                   "</li>\n";
                            }
                            else
                            {
