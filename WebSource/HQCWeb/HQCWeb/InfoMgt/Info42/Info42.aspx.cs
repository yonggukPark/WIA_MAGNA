...
namespace HQCWeb.InfoMgt.Info42
{
    public partial class Info42 : System.Web.UI.Page
    {
        ...
        Biz.InfoManagement.Info42 biz = new Biz.InfoManagement.Info42();
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "CAR_TYPE", "STN_CD", "DEV_ID", "SEQ_ID", "DIV_FLAG" };
        ...
        private void SetCon()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info42Data.Get_DdlData";
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Info42");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Info42");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "HIS_DATE", "HIS_DATETIME", "HIS_USER", "HIS_SEQ", "SHOP_CD", "LINE_NM", "STN_NM", "CAR_TYPE_NM", "DEV_NM", "SEQ_ID", "INS_CD", "INS_NM", "DIV_FLAG_NM", "TABLE_NM", "FINISH_FLAG", "INS_CD_MIN", "INS_CD_MAX", "ROMID_FLAG", "REMARK1", "REMARK2", "USE_YN", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "LINE_CD", "STN_CD", "CAR_TYPE", "DEV_ID", "DIV_FLAG", "KEY_HID" };
                        ...
                        arrColumnWidth[2] = "200";
                        arrColumnWidth[3] = "110";
                        arrColumnWidth[4] = "73";
                        arrColumnWidth[5] = "43";
                        arrColumnWidth[6] = "129";
                        arrColumnWidth[7] = "142";
                        arrColumnWidth[8] = "142";
                        arrColumnWidth[9] = "116";
                        arrColumnWidth[10] = "73";
                        arrColumnWidth[11] = "81";
                        arrColumnWidth[12] = "119";
                        arrColumnWidth[13] = "89";
                        arrColumnWidth[14] = "122";
                        arrColumnWidth[15] = "101";
                        arrColumnWidth[16] = "81";
                        arrColumnWidth[17] = "83";
                        arrColumnWidth[18] = "94";
                        arrColumnWidth[19] = "200";
                        arrColumnWidth[20] = "200";
                        arrColumnWidth[21] = "54";
                        arrColumnWidth[22] = "200";
                        arrColumnWidth[23] = "110";
                        arrColumnWidth[24] = "200";
                        arrColumnWidth[25] = "110";
                        arrColumnWidth[26] = "0";
                        arrColumnWidth[27] = "0";
                        arrColumnWidth[28] = "0";
                        arrColumnWidth[29] = "0";
        ...
        {
            lbHisDt.Text = Dictionary_Data.SearchDic("HIS_DATE", bp.g_language);
        ...
        public void GetData(string flag)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info42Data.Get_InspList";
            ...
            sParam.Add("CUR_MENU_ID", "Info42");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            logParam.Add("CUR_MENU_ID", "Info42");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
