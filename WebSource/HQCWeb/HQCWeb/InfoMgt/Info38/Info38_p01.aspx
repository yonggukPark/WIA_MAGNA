<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info38_p01.aspx.cs" Inherits="HQCWeb.InfoMgt.Info38.Info38_p01" %>
    ...
    <script type="text/javascript">
        function fn_Validation() {
            ...
            if ($("#PopupContent_ddlShopCd").val() == "") {
                ...
                alert("차종을 선택하세요.");
                return false;
            } else if ($("#PopupContent_txtScanCd").val() == "") {
                alert("스캔코드를 입력하세요.");
                return false;
    ...
    <div class="popup_wrap" tabindex="0">
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <th><b style="color:red;">*</b><asp:Label ID="lbScanCd" runat="server"></asp:Label></th>
                    <td>
                        <asp:TextBox ID="txtScanCd" runat="server" MaxLength="4"></asp:TextBox>
                    </td>
                ...
                <tr>
                    <th><asp:Label ID="lbChkType" runat="server"></asp:Label></th>
                    <td>
                        <asp:DropDownList ID="ddlChkType" runat="server"></asp:DropDownList>
                    </td>
