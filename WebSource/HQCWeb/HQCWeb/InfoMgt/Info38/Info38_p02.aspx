<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info38_p02.aspx.cs" Inherits="HQCWeb.InfoMgt.Info38.Info38_p02" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PopupContent" runat="server">
    <script type="text/javascript">

        function fn_ModifyConfirm() {
            if ($("#PopupContent_txtChkData").val() == "") {
                alert("체크데이터를 입력하세요.");
                return false;
