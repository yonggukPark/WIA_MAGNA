<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info38_p05.aspx.cs" Inherits="HQCWeb.InfoMgt.Info38.Info38_p05" %>
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lbGetMatchCd" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
