<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info03_p03.aspx.cs" Inherits="HQCWeb.InfoMgt.Info03.Info03_p03" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PopupContent" runat="server">
    <script type="text/javascript">
        function fn_Validation() {
            ...
            if ($("#PopupContent_ddlShopCd").val() == "") {
                ...
                alert("라인을 선택하세요.");
                return false;
            } else if ($("#PopupContent_txtCarType").val() == "") {
                alert("차종을 입력하세요.");
                return false;
            } else {
    ...
    <div class="popup_wrap" tabindex="0">
        <!--// Title -->
        <div class="title">
            <h1><asp:Label ID="lbTitle" runat="server">Info03</asp:Label> - <asp:Label ID="lbWorkName" runat="server"></asp:Label></h1>
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <th><asp:Label ID="lbCarNmKor" runat="server"></asp:Label></th>
                    <td>
                        <asp:TextBox ID="txtCarNmKor" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <th><asp:Label ID="lbProductCd" runat="server"></asp:Label></th>
                    <td>
                        <asp:TextBox ID="txtProductCd" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
