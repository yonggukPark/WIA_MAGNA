...
{
    public partial class Info03_p03 : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                txtCarType.Text = ds.Tables[0].Rows[0]["CAR_TYPE"].ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (su.SetControlValChk(this.Page.Master, "PopupContent"))
            {
                ...
                strDBName = "GPDB";
                strQueryID = "Info03Data.Get_CarID_ValChk";
                ...
                sParamIDChk.Add("CAR_TYPE", txtCarType.Text);

                // 아이디 체크 비지니스 메서드 작성
                strRtn = biz.GetCarValChk(strDBName, strQueryID, sParamIDChk);
                if (strRtn == "0")
                {
                    strDBName = "GPDB";
                    ...
                    sParam.Add("CAR_TYPE", txtCarType.Text);
                    ...
                    if (iRtn == 1)
                    {
                        strScript = " alert('정상등록 되었습니다.');  parent.fn_ModalReloadCall('Info03'); parent.fn_ModalCloseDiv(); ";
                        ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                    }
                    else
                    {
