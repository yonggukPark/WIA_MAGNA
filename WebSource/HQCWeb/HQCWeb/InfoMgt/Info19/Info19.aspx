...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        function fn_Image(pkCode) {
            fn_PostOpenPop(pkCode, 'InfoMgt/Info19/Info19_p03.aspx', '500', '800');
        }

        function fn_Copy() {
            if (currentValue != undefined)
                fn_PostOpenPop(currentValue, 'InfoMgt/Info19/Info19_p04.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
            else
        ...
        function settingGrid(_val) {
            ...
            gridView.columnByName("MODE_FLAG_NAME").styleName = "string-column";
                ...
                <ContentTemplate>
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td style="padding:0px">
                                <asp:DropDownList ID="ddlModeFlag" runat="server" Width="100"></asp:DropDownList>
                            </td>
                            <td class="al-r">
                                <%--<asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click" OnClientClick="javascript:return fn_Validation();" Visible="false" />
                                <asp:Button ID="btnRestore" runat="server" Text="Restore" OnClick="btnRestore_Click" OnClientClick="javascript:return fn_Validation();" Visible="false" />
                        ...
                        <tr>
                            <td>
                                <div class="toolbar">
                                    ...
                                    <input type="button" value="Set" id="btnSet" onclick="getCol('Info19'); return false;" style="display:none; margin-top:10px; float:left" />
