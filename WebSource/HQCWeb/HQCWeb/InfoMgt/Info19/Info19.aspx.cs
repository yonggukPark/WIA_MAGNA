...
{
    public partial class Info19 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "STN_CD", "CAR_TYPE", "WORK_SEQ" };
        ...
        private void SetCon()
        {
            ...
            ddlModeFlag.Items.Add(new ListItem("선택하세요", ""));
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Info19");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Info19");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "MODE_FLAG", "MODE_FLAG_NAME", "SHOP_CD", "LINE_CD", "CAR_TYPE", "STN_CD", "WORK_CD", "WORK_NM", "WORK_SEQ", "TOOL_TYPE", "CNT", "TORQUE_TYPE", "P_SET", "TOOL_HOLE", "DEV_ID", "WORK_TYPE_NM", "WORK_TYPE", "SCAN_CD", "MATCH_CD", "TOOL_IMG", "REMARK1", "REMARK2", "USE_YN", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "POINT", "KEY_HID" };
        ...
        public void GetData(string flag)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info19Data.Get_WorkList";
            ...
            logParam.Add("CUR_MENU_ID", "Info19");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요

            btnlog.SetCUD(strDBName, "ButtonStatisticsData.Set_ButtonHisInfo", logParam);// 버튼로그 저장

            // 비지니스 메서드 호출
            ds = biz.GetWorkOrder(strDBName, strQueryID, sParam);
