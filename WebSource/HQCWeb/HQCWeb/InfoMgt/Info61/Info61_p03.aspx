<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info61_p03.aspx.cs" Inherits="HQCWeb.InfoMgt.Info61.Info61_p03" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PopupContent" runat="server">
    <script type="text/javascript">
        function fn_Validation() {
            if ($("#PopupContent_txtDCode").val() == "") {
                alert("불량코드를 입력하세요.");
                return false;
            } else {
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtDCode" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
