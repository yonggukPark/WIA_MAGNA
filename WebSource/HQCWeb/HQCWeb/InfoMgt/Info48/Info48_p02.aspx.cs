...
namespace HQCWeb.InfoMgt.Info48
{
    public partial class Info48_p02 : System.Web.UI.Page
    {
        ...
        // 비지니스 클래스 작성
        Biz.InfoManagement.Info48 biz = new Biz.InfoManagement.Info48();
        ...
        private void SetCon()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info48Data.Get_DdlData";
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                {
                    ddlLineGroupCd.Items.Add(new ListItem(ds.Tables[0].Rows[i]["CODE_NM"].ToString(), ds.Tables[0].Rows[i]["CODE_ID"].ToString()));
                }
        ...
        private void SetTitle()
        {
            ...
            lbLineGroupCd.Text = Dictionary_Data.SearchDic("LINE_GROUP_CD", bp.g_language);
        ...
        protected void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info48Data.Get_LineGrpMatchInfo";
            ...
            sParam.Add("LINE_GROUP_CD", strSplitValue[3].ToString());

            sParam.Add("CUR_MENU_ID", "Info48");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                ddlLineGroupCd.SelectedValue = ds.Tables[0].Rows[0]["LINE_GROUP_CD"].ToString();
            ...
            {
                strScript = " alert('정보가 존재하지 않습니다. 관리자에게 문의바립니다.'); parent.fn_ModalReloadCall('Info48'); parent.fn_ModalCloseDiv(); ";
        ...
        protected void btnModify_Click(object sender, EventArgs e)
        {
            ...
            {
                strDBName = "GPDB";
                strQueryID = "Info48Data.Get_LineGrpMatchID_ValChk";
                ...
                sParamIDChk.Add("LINE_GROUP_CD", ddlLineGroupCd.SelectedValue);

                // 아이디 체크 비지니스 메서드 작성
                strRtn = biz.GetLineMatchValChk(strDBName, strQueryID, sParamIDChk);
                if (strRtn == "0")
                {
                    strDBName = "GPDB";
                    strQueryID = "Info48Data.Set_LineGrpMatchInfo";

                    FW.Data.Parameters sParam = new FW.Data.Parameters();
                    sParam.Add("PLANT_CD", strSplitValue[0].ToString());
                    sParam.Add("SHOP_CD", strSplitValue[1].ToString());
                    sParam.Add("LINE_CD", strSplitValue[2].ToString());
                    sParam.Add("LINE_GROUP_CD", ddlLineGroupCd.SelectedValue);
                    ...
                    if (iRtn == 1)
                    {
                        ...
                        strScript = " alert('정상수정 되었습니다.');  parent.fn_ModalReloadCall('Info48'); parent.fn_ModalCloseDiv(); ";
                        ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                    }
                    else
                    {
                ...
                {
                    strScript = " alert('존재하는 데이터입니다. 등록하려는 데이터를 다시 입력하세요.'); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                strDBName = "GPDB";
                strQueryID = "Info48Data.Set_LineGrpMatchInfoDel";
                ...
                if (iRtn == 1)
                {
                    ...
                    strScript = " alert('정상삭제 되었습니다.');  parent.fn_ModalReloadCall('Info48'); parent.fn_ModalCloseDiv(); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
                else
                {
            ...
            {
                strScript = " alert('이미 정보가 존재하지 않습니다.'); parent.fn_ModalReloadCall('Info48'); parent.fn_ModalCloseDiv(); ";
                ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
            }
        }
        #endregion
        ...
        protected void btnRestore_Click(object sender, EventArgs e)
        {
            ...
            if (iRtn == 1)
            {
                ...
                strScript = " alert('정상복구 되었습니다.');  parent.fn_ModalReloadCall('Info48'); parent.fn_ModalCloseDiv(); ";
                ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
            }
            else
            {
