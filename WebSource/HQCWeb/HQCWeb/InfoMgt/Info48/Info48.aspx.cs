...
{
    public partial class Info48 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "LINE_GROUP_CD" };
        ...
        private void SetCon()
        {
            ...
            ddlLineGrpCd.Items.Add(new ListItem("ALL", ""));
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                {
                    ddlLineGrpCd.Items.Add(new ListItem(ds.Tables[0].Rows[i]["CODE_NM"].ToString(), ds.Tables[0].Rows[i]["CODE_ID"].ToString()));
                }
            }
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Info48");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Info48");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "LINE_GROUP_CD", "LINE_GROUP_NM", "SHOP_CD", "LINE_CD", "LINE_NM", "REMARK1", "REMARK2", "USE_YN", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "KEY_HID" };
        ...
        {
            lbLineGrpCd.Text = Dictionary_Data.SearchDic("LINE_GROUP_CD", bp.g_language);
        }
        #endregion
        ...
        public void GetData(string flag)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info48Data.Get_LineGrpMatchList";

            FW.Data.Parameters sParam = new FW.Data.Parameters();
            sParam.Add("PLANT_CD", bp.g_plant.ToString());
            sParam.Add("LINE_GROUP_CD", ddlLineGrpCd.SelectedValue);
            ...
            logParam.Add("CUR_MENU_ID", "Info48");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요

            btnlog.SetCUD(strDBName, "ButtonStatisticsData.Set_ButtonHisInfo", logParam);// 버튼로그 저장

            // 비지니스 메서드 호출
            ds = biz.GetLineGrpMatch(strDBName, strQueryID, sParam);
