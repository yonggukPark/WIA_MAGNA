...
{
    public partial class Info04 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD" };
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Info04");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Info04");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "LINE_NM", "CYC_TM", "DISP_GD", "WCT_YN", "EOP_FLAG", "EOP_DATE", "REMARK1", "REMARK2", "USE_YN", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "KEY_HID" };
                        ...
                        arrColumnWidth[0] = "50";
                        arrColumnWidth[1] = "55";
                        arrColumnWidth[2] = "104";
                        arrColumnWidth[3] = "151";
                        arrColumnWidth[4] = "65";
                        arrColumnWidth[5] = "97";
                        arrColumnWidth[6] = "60";
                        arrColumnWidth[7] = "60";
                        ...
                        arrColumnWidth[9] = "178";
                        arrColumnWidth[10] = "181";
                        arrColumnWidth[11] = "54";
                        arrColumnWidth[12] = "129";
                        arrColumnWidth[13] = "130";
                        arrColumnWidth[14] = "129";
                        arrColumnWidth[15] = "127";
                        arrColumnWidth[16] = "0";
                    }
                }
            }
        ...
        public void GetData(string flag)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info04Data.Get_LineList";
            ...
            logParam.Add("CUR_MENU_ID", "Info04");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요

            btnlog.SetCUD(strDBName, "ButtonStatisticsData.Set_ButtonHisInfo", logParam);// 버튼로그 저장

            // 비지니스 메서드 호출
            ds = biz.GetLineCd(strDBName, strQueryID, sParam);
