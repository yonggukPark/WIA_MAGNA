...
namespace HQCWeb.InfoMgt.Info04
{
    public partial class Info04_p02 : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                if (ds.Tables[0].Rows[0]["DEL_YN"].ToString().Equals("Y"))
                {
                    ...
                    ddlEopFlag.Enabled = false;
                    ddlWctYn.Enabled = false;
                ...
                else
                {
                    ...
                    ddlEopFlag.Enabled = true;
                    ddlWctYn.Enabled = true;
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                strScript = " alert('이미 정보가 존재하지 않습니다.'); parent.fn_ModalReloadCall('Info04'); parent.fn_ModalCloseDiv(); ";
                ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
            }
        }
        #endregion
