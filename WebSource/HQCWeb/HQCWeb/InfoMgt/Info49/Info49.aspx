<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Info49.aspx.cs" Inherits="HQCWeb.InfoMgt.Info49.Info49" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        function fn_Register() {
            fn_OpenPop('InfoMgt/Info49/Info49_p01.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
        }

        function fn_Modify(pkCode) {
            fn_PostOpenPop(pkCode, 'InfoMgt/Info49/Info49_p02.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
        }

        function fn_Copy() {
            if (currentValue != undefined)
                fn_PostOpenPop(currentValue, 'InfoMgt/Info49/Info49_p03.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
            else
        ...
        function settingGrid(_val) {
            ...
            gridView.columnByName("ERROR_CD").styleName = "grid-primary-column"
            gridView.columnByName("ERROR_NM").styleName = "string-column"
    ...
    <div class="contents" tabindex="0">
        <!--// Title + Win_Btn -->
        <div class="title">
            <h3><asp:Label ID="lbTitle" runat="server">Info49</asp:Label></h3>
            <div class="al-r">
                ...
                <input type="button" value="Excel" id="btnExcel" runat="server" visible="false" onclick="fn_excelExport('Info49'); return false;" />
            </div>
        </div>
        <!-- Title + Win_Btn //-->
        <!--// Grid Search -->
        <div class="search_grid mt13">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <th><asp:Label ID="lbErrorCd" runat="server"></asp:Label></th>
                    <td><asp:TextBox ID="txtErrorCd" runat="server" style="width:150px;"></asp:TextBox></td>
                    <th><asp:Label ID="lbErrorNm" runat="server"></asp:Label></th>
                    <td><asp:TextBox ID="txtErrorNm" runat="server" style="width:150px;"></asp:TextBox></td>
                    <td class="al-r">
                        <%--<asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click" OnClientClick="fn_WatingCall();" Visible="false" />
                        <asp:Button ID="btnRestore" runat="server" Text="Restore" OnClick="btnRestore_Click" OnClientClick="fn_WatingCall();" Visible="false" />
                        <input type="button" value="New" onclick="javascript:fn_Register();" ID="btnNew" runat="server" visible="false" />
                        ...
                        <tr>
                            <td>
                                <div class="toolbar">
                                    ...
                                    <input type="button" value="Set" id="btnSet" onclick="getCol('Info49'); return false;" style="display:none; margin-top:10px; float:left" />
