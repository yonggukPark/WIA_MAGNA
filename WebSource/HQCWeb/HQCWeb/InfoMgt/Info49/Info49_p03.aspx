<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info49_p03.aspx.cs" Inherits="HQCWeb.InfoMgt.Info49.Info49_p03" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PopupContent" runat="server">
    <script type="text/javascript">
        function fn_Validation() {
            if ($("#PopupContent_txtErrorCd").val() == "") {
                alert("에러코드를 입력하세요.");
                return false;
            } else {
    ...
    <div class="popup_wrap" tabindex="0">
        <!--// Title -->
        <div class="title">
            <h1><asp:Label ID="lbTitle" runat="server">Info49</asp:Label> - <asp:Label ID="lbWorkName" runat="server"></asp:Label></h1>
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtErrorCd" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <th><asp:Label ID="lbErrorNm" runat="server"></asp:Label></th>
                    <td>
                        <asp:TextBox ID="txtErrorNm" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
