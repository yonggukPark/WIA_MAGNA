<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Info11.aspx.cs" Inherits="HQCWeb.InfoMgt.Info11.Info11" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">

        function fn_Register() {
            fn_OpenPop('InfoMgt/Info11/Info11_p01.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
        }

        function fn_Modify(pkCode) {
            fn_PostOpenPop(pkCode, 'InfoMgt/Info11/Info11_p02.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
        }

        function fn_Copy() {
            if (currentValue != undefined)
                fn_PostOpenPop(currentValue, 'InfoMgt/Info11/Info11_p03.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
            else
        ...
        function settingGrid(_val) {
            ...
            gridView.columnByName("MON_CD").styleName = "grid-primary-column"
            gridView.columnByName("MON_NM").styleName = "string-column";
    ...
    <asp:HiddenField ID="hidHeight" runat="server" Value="440" />

    <div class="contents" tabindex="0">
        <!--// Title + Win_Btn -->
        <div class="title">
            <h3><asp:Label ID="lbTitle" runat="server">Info11</asp:Label></h3>
            <div class="al-r">
                        ...
                        <tr>
                            <td>
                                <div class="toolbar">
                                    ...
                                    <input type="button" value="Set" id="btnSet" onclick="getCol('Info11'); return false;" style="display:none; margin-top:10px; float:left" />
