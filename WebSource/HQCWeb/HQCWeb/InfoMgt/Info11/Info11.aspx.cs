...
{
    public partial class Info11 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "MON_CD" };
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Info11");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Info11");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] {"PLANT_CD", "MON_CD", "MON_NM", "USE_FLG", "MESSAGE", "REMARK1", "REMARK2", "USE_YN", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "KEY_HID" };
        ...
        public void GetData(string flag)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info11Data.Get_MonList";
            ...
            logParam.Add("CUR_MENU_ID", "Info11");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
