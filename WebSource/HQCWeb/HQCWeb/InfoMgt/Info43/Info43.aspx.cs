...
{
    public partial class Info43 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "STORAGE_CD" };
        ...
        private void SetCon()
        {
            ...
            ddlStorageType.Items.Add(new ListItem("ALL", ""));
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Info43");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Info43");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "STORAGE_CD", "STORAGE_NM", "STORAGE_TYPE", "DISP_ORDER", "RETURN_TYPE", "DECOMPOSE_TYPE", "REMARK1", "REMARK2", "USE_YN", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "KEY_HID" };
        ...
        public void GetData(string flag)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info43Data.Get_StorageList";

            FW.Data.Parameters sParam = new FW.Data.Parameters();
            sParam.Add("PLANT_CD", bp.g_plant.ToString());
            sParam.Add("STORAGE_NM", txtStorageNm.Text);
            sParam.Add("STORAGE_TYPE", ddlStorageType.Text);
            ...
            logParam.Add("CUR_MENU_ID", "Info43");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
