...
{
    public partial class Info02_p02 : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                lbGetCdGrp.Text = ds.Tables[0].Rows[0]["CD_GRP"].ToString();
                ...
                if (ds.Tables[0].Rows[0]["DEL_YN"].ToString().Equals("Y"))
                {
                    ...
                    txtCdNm.Enabled = false;
                    txtCdDesc1.Enabled = false;
                    txtCdDesc2.Enabled = false;
                    txtCdDesc3.Enabled = false;
                    txtCdDesc4.Enabled = false;
                    txtCdDesc5.Enabled = false;
                    txtCdDesc6.Enabled = false;
                    txtCdDesc7.Enabled = false;
                ...
                else
                {
                    ...
                    txtCdNm.Enabled = true;
                    txtCdDesc1.Enabled = true;
                    txtCdDesc2.Enabled = true;
                    txtCdDesc3.Enabled = true;
                    txtCdDesc4.Enabled = true;
                    txtCdDesc5.Enabled = true;
                    txtCdDesc6.Enabled = true;
                    txtCdDesc7.Enabled = true;
        ...
        protected void btnModify_Click(object sender, EventArgs e)
        {
            ...
            if (su.SetControlValChk(this.Page.Master, "PopupContent"))
            {
                ...
                if (iRtn == 1)
                {
                    ...
                    strScript = " alert('정상수정 되었습니다.');  parent.fn_ModalReloadCall('Info02'); parent.fn_ModalCloseDiv(); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
                else
                {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                strDBName = "GPDB";
                strQueryID = "Info02Data.Set_CodeInfoDel";
                ...
                if (iRtn == 1)
                {
                    ...
                    strScript = " alert('정상삭제 되었습니다.');  parent.fn_ModalReloadCall('Info02'); parent.fn_ModalCloseDiv(); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
                else
                {
            ...
            {
                strScript = " alert('이미 정보가 존재하지 않습니다.'); parent.fn_ModalReloadCall('Info02'); parent.fn_ModalCloseDiv(); ";
                ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
            }
        }
        #endregion
        ...
        protected void btnRestore_Click(object sender, EventArgs e)
        {
            ...
            if (iRtn == 1)
            {
                ...
                strScript = " alert('정상복원 되었습니다.');  parent.fn_ModalReloadCall('Info02'); parent.fn_ModalCloseDiv(); ";
                ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
            }
            else
            {
