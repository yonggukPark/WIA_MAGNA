...
{
    public partial class Info02 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "CD_GRP", "CODE" };
        ...
        private void SetCon()
        {
            ...
            ddlCdGrp.Items.Add(new ListItem("ALL", ""));
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                {
                    ddlCdGrp.Items.Add(new ListItem(ds.Tables[0].Rows[i]["CODE_NM"].ToString(), ds.Tables[0].Rows[i]["CODE_ID"].ToString()));
                }
            }
        }
        #endregion
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Info02");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Info02");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "CD_GRP", "CODE", "CD_NM", "CD_DESC1", "CD_DESC2", "CD_DESC3", "CD_DESC4", "CD_DESC5", "CD_DESC6", "CD_DESC7", "REMARK1", "REMARK2", "USE_YN", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "KEY_HID" };
        ...
        {
            lbCdGrp.Text = Dictionary_Data.SearchDic("CODE_GRP", bp.g_language);
        ...
        public void GetData(string flag)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info02Data.Get_CodeList";

            FW.Data.Parameters sParam = new FW.Data.Parameters();
            sParam.Add("PLANT_CD", bp.g_plant.ToString());
            sParam.Add("CD_GRP", ddlCdGrp.SelectedValue);
            ...
            logParam.Add("CUR_MENU_ID", "Info02");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요

            btnlog.SetCUD(strDBName, "ButtonStatisticsData.Set_ButtonHisInfo", logParam);// 버튼로그 저장

            // 비지니스 메서드 호출
            ds = biz.GetCodeList(strDBName, strQueryID, sParam);
