<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info02_p02.aspx.cs" Inherits="HQCWeb.InfoMgt.Info02.Info02_p02" %>
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lbGetCdGrp" runat="server"></asp:Label>
                    </td>
                    <th><asp:Label ID="lbCode" runat="server"></asp:Label></th>
                    <td>
