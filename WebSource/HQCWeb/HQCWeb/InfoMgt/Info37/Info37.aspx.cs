...
{
    public partial class Info37 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의(COLUMN_SEQ = SCAN_SEQ)
        public string[] strKeyColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "STN_CD", "CAR_TYPE", "COLUMN_SEQ", "SCAN_CD"  };
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Info37");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Info37");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "STN_CD", "CAR_TYPE", "SCAN_CD", "SCAN_NM", "COLUMN_SEQ", "PART_NO", "SCAN_PART_NO", "CHK_DATA", "BRCD_CHECK", "CHK_TYPE", "REMARK1", "REMARK2", "USE_YN", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "KEY_HID" };
                        ...
                        arrColumnWidth[7] = "90";
                        arrColumnWidth[8] = "92";
                        arrColumnWidth[9] = "101";
                        arrColumnWidth[10] = "232";
                        arrColumnWidth[11] = "224";
                        arrColumnWidth[12] = "69";
                        arrColumnWidth[13] = "200";
                        arrColumnWidth[14] = "200";
                        arrColumnWidth[15] = "54";
                        arrColumnWidth[16] = "129";
                        arrColumnWidth[17] = "83";
                        arrColumnWidth[18] = "129";
                        arrColumnWidth[19] = "76";
                        arrColumnWidth[20] = "0";
        ...
        public void GetData(string flag)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info37Data.Get_ScanList";
            ...
            logParam.Add("CUR_MENU_ID", "Info37");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
