<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info60_p01.aspx.cs" Inherits="HQCWeb.InfoMgt.Info60.Info60_p01" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PopupContent" runat="server">
    <script type="text/javascript">
        function fn_Validation() {

            if ($("#PopupContent_txtDecomposeCd").val() == "") {
                alert("분해 사유 코드를 입력하세요.");
                return false;
            } else {
    ...
    <div class="popup_wrap" tabindex="0">
        <!--// Title -->
        <div class="title">
            <h1><asp:Label ID="lbTitle" runat="server">Info60</asp:Label> - <asp:Label ID="lbWorkName" runat="server"></asp:Label></h1>
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <th><b style="color:red;">*</b><asp:Label ID="lbDecomposeCd" runat="server"></asp:Label></th>
                    <td>
                        <asp:TextBox ID="txtDecomposeCd" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <th><asp:Label ID="lbDecomposeDesc" runat="server"></asp:Label></th>
                    <td>
                        <asp:TextBox ID="txtDecomposeDesc" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
