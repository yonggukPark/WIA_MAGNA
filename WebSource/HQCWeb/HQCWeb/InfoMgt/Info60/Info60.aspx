<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Info60.aspx.cs" Inherits="HQCWeb.InfoMgt.Info60.Info60" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">

        function fn_Register() {
            fn_OpenPop('InfoMgt/Info60/Info60_p01.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
        }

        function fn_Modify(pkCode) {
            fn_PostOpenPop(pkCode, 'InfoMgt/Info60/Info60_p02.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
        }

        function fn_Copy() {
            if (currentValue != undefined)
                fn_PostOpenPop(currentValue, 'InfoMgt/Info60/Info60_p03.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
            else
        ...
        function settingGrid(_val) {
            ...
            gridView.onCellClicked = function (grid, clickData) {
                ...
                if (clickData.column == 'DECOMPOSE_CD') {
                    fn_Modify(value);
                }
            }
            ...
            gridView.columnByName("DECOMPOSE_CD").styleName = "grid-primary-column"
            gridView.columnByName("DECOMPOSE_DESC").styleName = "string-column";
    ...
    <div class="contents" tabindex="0">
        <!--// Title + Win_Btn -->
        <div class="title">
            <h3><asp:Label ID="lbTitle" runat="server">Info60</asp:Label></h3>
            <div class="al-r">
                ...
                <input type="button" value="Excel" id="btnExcel" runat="server" visible="false" onclick="fn_excelExport('Info60'); return false;" />
            </div>
        </div>
        <!-- Title + Win_Btn //-->
        <!--// Grid Search -->
        <div class="search_grid mt13">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <th><asp:Label ID="lbDecomposeCd" runat="server"></asp:Label></th>
                    <td><asp:TextBox ID="txtDecomposeCd" runat="server" style="width:150px;"></asp:TextBox></td>
                    <th><asp:Label ID="lbDecomposeDesc" runat="server"></asp:Label></th>
                    <td><asp:TextBox ID="txtDecomposeDesc" runat="server" style="width:150px;"></asp:TextBox></td>
                    <td class="al-r">
                        ...
                        <tr>
                            <td>
                                <div class="toolbar">
                                    ...
                                    <input type="button" value="Set" id="btnSet" onclick="getCol('Info60'); return false;" style="display:none; margin-top:10px; float:left" />
