<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info56_p01.aspx.cs" Inherits="HQCWeb.InfoMgt.Info56.Info56_p01" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PopupContent" runat="server">
    <script type="text/javascript">
        function fn_Validation() {

            if ($("#PopupContent_txtPalletNo").val() == "") {
                alert("PALLET NO를 입력하세요.");
                return false;
            } else if ($("#PopupContent_txtMaxQty").val() == "" || Number($("#PopupContent_txtMaxQty").val()) <= 0) {
                alert("적재수량을 입력하세요.");
                return false;
            } else {
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtPalletNo" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
