...
{
    public partial class Info56_p02 : System.Web.UI.Page
    {
        ...
        private void SetTitle()
        {
            ...
            lbMaxQty.Text = Dictionary_Data.SearchDic("MAX_QTY", bp.g_language);
        ...
        protected void GetData()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    lbGetPalletNo.Text = ds.Tables[0].Rows[0]["PALLET_NO"].ToString();
                    txtPalletMapNo.Text = ds.Tables[0].Rows[0]["PALLET_MAP_NO"].ToString();
                    txtMaxQty.Text = ds.Tables[0].Rows[0]["MAX_QTY"].ToString();
        ...
        protected void btnModify_Click(object sender, EventArgs e)
        {
            ...
            if (su.SetControlValChk(this.Page.Master, "PopupContent"))
            {
                ...
                sParam.Add("MAX_QTY", txtMaxQty.Text);
                ...
                if (iRtn == 1)
                {
                    ...
                    strScript = " alert('정상수정 되었습니다.');  parent.fn_ModalReloadCall('Info56'); parent.fn_ModalCloseDiv(); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
                else
                {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                strDBName = "GPDB";
                strQueryID = "Info56Data.Set_PalletInfoDel";
                ...
                if (iRtn == 1)
                {
                    ...
                    strScript = " alert('정상삭제 되었습니다.');  parent.fn_ModalReloadCall('Info56'); parent.fn_ModalCloseDiv(); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
                else
                {
            ...
            {
                strScript = " alert('이미 정보가 존재하지 않습니다.'); parent.fn_ModalReloadCall('Info56'); parent.fn_ModalCloseDiv(); ";
                ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
            }
        }
        #endregion
        ...
        protected void btnRestore_Click(object sender, EventArgs e)
        {
            ...
            if (iRtn == 1)
            {
                ...
                strScript = " alert('정상복원 되었습니다.');  parent.fn_ModalReloadCall('Info56'); parent.fn_ModalCloseDiv(); ";
                ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
            }
            else
            {
