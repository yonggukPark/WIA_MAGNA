...
{
    public partial class Info39_p02 : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                lbGetMasterSerialNo.Text = ds.Tables[0].Rows[0]["MASTER_SERIAL_NO"].ToString();
        ...
        protected void btnModify_Click(object sender, EventArgs e)
        {
            ...
            if (su.SetControlValChk(this.Page.Master, "PopupContent"))
            {
                ...
                if (iRtn == 1)
                {
                    ...
                    strScript = " alert('정상수정 되었습니다.');  parent.fn_ModalReloadCall('Info39'); parent.fn_ModalCloseDiv(); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
                else
                {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                strDBName = "GPDB";
                strQueryID = "Info39Data.Set_MasterInfoDel";
                ...
                if (iRtn == 1)
                {
                    ...
                    strScript = " alert('정상삭제 되었습니다.');  parent.fn_ModalReloadCall('Info39'); parent.fn_ModalCloseDiv(); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
                else
                {
            ...
            {
                strScript = " alert('이미 정보가 존재하지 않습니다.'); parent.fn_ModalReloadCall('Info39'); parent.fn_ModalCloseDiv(); ";
                ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
            }
        }
        #endregion
        ...
        protected void btnRestore_Click(object sender, EventArgs e)
        {
            ...
            if (su.SetControlValChk(this.Page.Master, "PopupContent"))
            {
                ...
                if (iRtn == 1)
                {
                    ...
                    strScript = " alert('정상복원 되었습니다.');  parent.fn_ModalReloadCall('Info39'); parent.fn_ModalCloseDiv(); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
                else
                {
