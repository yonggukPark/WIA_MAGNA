<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Info39.aspx.cs" Inherits="HQCWeb.InfoMgt.Info39.Info39" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        function fn_Register() {
            fn_OpenPop('InfoMgt/Info39/Info39_p01.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
        }

        function fn_Modify(pkCode) {
            fn_PostOpenPop(pkCode, 'InfoMgt/Info39/Info39_p02.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
        }

        function fn_Copy() {
            if (currentValue != undefined)
                fn_PostOpenPop(currentValue, 'InfoMgt/Info39/Info39_p03.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
            else
                alert("먼저 복사할 행을 선택해주세요.");
        }

        function fn_Upload() {
            fn_OpenPop('InfoMgt/Info39/Info39_p04.aspx', $("#MainContent_hidWidth").val(), '180');
        }
        ...
        function settingGrid(_val) {
            ...
            gridView.onCellClicked = function (grid, clickData) {
                if (clickData.column == 'MASTER_SERIAL_NO') {
            ...
            gridView.columnByName("MASTER_SERIAL_NO").styleName = "grid-primary-column"

            gridView.columnByName("REMARK1").styleName = "string-column";
            gridView.columnByName("REMARK2").styleName = "string-column";

            gridView.columnByName("SEQ").visible = false;
    ...
    <div class="contents">
        <!--// Title + Win_Btn -->
        <div class="title">
            <h3><asp:Label ID="lbTitle" runat="server">Info39</asp:Label></h3>
            <div class="al-r">
                ...
                <input type="button" value="Excel" id="btnExcel" runat="server" visible="false" onclick="fn_excelExport('Info39'); return false;" />
        ...
        <div class="search_grid mt13">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <th><asp:Label ID="lbMasterSerialNo" runat="server"></asp:Label></th>
                    <td><asp:TextBox ID="txtMasterSerialNo" runat="server" style="width:250px;"></asp:TextBox></td>
                    <td class="al-r">
                    </td>
                </tr>
            </table>
                        ...
                        <tr>
                            <td>
                                <div class="toolbar">
                                    ...
                                    <input type="button" value="Set" id="btnSet" onclick="getCol('Info39'); return false;" style="display:none; margin-top:10px; float:left" />
