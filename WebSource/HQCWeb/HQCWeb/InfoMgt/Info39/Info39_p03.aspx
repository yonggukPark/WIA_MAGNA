<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info39_p03.aspx.cs" Inherits="HQCWeb.InfoMgt.Info39.Info39_p03" %>
    ...
    <script type="text/javascript">
        function fn_Validation() {
            ...
            if ($("#PopupContent_ddlShopCd").val() == "") {
                ...
                alert("차종을 선택하세요.");
                return false;
            } else if ($("#PopupContent_txtMasterSerialNo").val() == "") {
                alert("마스터바코드를 입력하세요.");
                return false;
            } else {
    ...
    <div class="popup_wrap">
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <th><b style="color:red;">*</b><asp:Label ID="lbMasterSerialNo" runat="server"></asp:Label></th>
                    <td>
                        <asp:TextBox ID="txtMasterSerialNo" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
