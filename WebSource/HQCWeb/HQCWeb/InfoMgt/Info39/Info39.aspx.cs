...
{
    public partial class Info39 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "SHOP_CD","LINE_CD","CAR_TYPE","MASTER_SERIAL_NO","SEQ" };
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Info39");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Info39");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "CAR_TYPE", "MASTER_SERIAL_NO", "REMARK1", "REMARK2", "USE_YN", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "SEQ", "KEY_HID" };
                        ...
                        arrColumnWidth[5] = "290";
                        arrColumnWidth[6] = "290";
                        arrColumnWidth[7] = "55";
                        arrColumnWidth[8] = "130";
                        arrColumnWidth[9] = "130";
                        arrColumnWidth[10] = "130";
        ...
        public void GetData(string flag)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info39Data.Get_MasterList";
            ...
            logParam.Add("CUR_MENU_ID", "Info39");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
