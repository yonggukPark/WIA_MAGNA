...
{
    public partial class Info40 : System.Web.UI.Page
    {
        ...
        private void SetCon()
        {
            ...
            ddlEOLGubun.Items.Add(new ListItem("ALL", ""));
            ddlEOLGubun.Enabled = false;
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Info40");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Info40");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_NM", "STN_NM", "CAR_TYPE_NM", "DEV_NM", "SEQ_ID", "INS_CD", "INS_NM", "DIV_FLAG_NM", "TABLE_NM", "FINISH_FLAG", "INS_CD_MIN", "INS_CD_MAX", "ROMID_FLAG", "REMARK1", "REMARK2", "USE_YN", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "LINE_CD","STN_CD","CAR_TYPE","DEV_ID","DIV_FLAG","KEY_HID" };
        ...
        private void SetTitle()
        {
            ...
            lbEOLGubun.Text = Dictionary_Data.SearchDic("EOL_GUBUN", bp.g_language);
        }
        #endregion
        ...
        public void GetData(string flag)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info40Data.Get_InspList";
            ...
            sParam.Add("EOL_GUBUN", ddlEOLGubun.SelectedValue);
            ...
            logParam.Add("CUR_MENU_ID", "Info40");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
        ...
        #region ddlDevCd_SelectedIndexChanged
        protected void ddlDevCd_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                if (ds.Tables[8].Rows.Count > 0)
                {
                    ...
                    {
                        ddlEOLGubun.Items.Add(new ListItem(ds.Tables[8].Rows[i]["CODE_NM"].ToString(), ds.Tables[8].Rows[i]["CODE_ID"].ToString()));
                    }
                    ddlEOLGubun.Enabled = true;
                }
            }
        }
        #endregion
