...
namespace HQCWeb.InfoMgt.InfoTest
{
    public partial class InfoTest : System.Web.UI.Page
    {
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "InfoTest");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "InfoTest");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "PLANT_NM", "KEY_HID" };
        ...
        {
            lbCond_01.Text = Dictionary_Data.SearchDic("CODE_NM", bp.g_language);
        ...
        public void GetData(string flag)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "InfoTestData.Get_DdlData";

            // 비지니스 클래스 작성
            //Biz.Sample_Biz biz = new Biz.Sample_Biz();

            FW.Data.Parameters sParam = new FW.Data.Parameters();
            sParam.Add("PLANT_CD", txtCondi1.Text);
