<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="InfoTest_P01.aspx.cs" Inherits="HQCWeb.InfoMgt.InfoTest.InfoTest_P01" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PopupContent" runat="server">
    ...
    <div class="popup_wrap">
        <!--// Title -->
        <div class="title">
            <h1><asp:Label ID="lbTitle" runat="server">InfoTest</asp:Label> - 팝업<asp:Label ID="lbWorkName" runat="server"></asp:Label></h1>
