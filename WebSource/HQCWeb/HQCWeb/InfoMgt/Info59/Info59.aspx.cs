...
{
    public partial class Info59 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "STN_CD", "CAR_TYPE", "WORK_SEQ", "DEV_ID", "P_SET", "WORK_CD" };
        ...
        private void SetCon()
        {
            ...
            ddlItemGroup.Items.Add(new ListItem("ALL", ""));
            ddlUseYn.Items.Add(new ListItem("ALL", ""));
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Info59");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Info59");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "CAR_TYPE", "STN_CD", "WORK_CD", "WORK_NM", "ITEM_05", "ITEM_12", "ITEM_13", "ITEM_08", "ITEM_09", "ITEM_02", "ITEM_03", "ITEM_04", "DEV_NM", "CNT", "MOD_DATE", "MOD_USER", "KEY_HID" };
                        ...
                        arrColumnWidth[2] = "46";
                        arrColumnWidth[3] = "46";
                        arrColumnWidth[4] = "100";
                        arrColumnWidth[5] = "309";
                        arrColumnWidth[6] = "63";
                        arrColumnWidth[7] = "93";
                        arrColumnWidth[8] = "93";
                        arrColumnWidth[9] = "93";
                        arrColumnWidth[10] = "93";
                        arrColumnWidth[11] = "93";
                        arrColumnWidth[12] = "93";
                        arrColumnWidth[13] = "68";
                        arrColumnWidth[14] = "191";
                        arrColumnWidth[15] = "32";
                        arrColumnWidth[16] = "129";
                        arrColumnWidth[17] = "76";
                        arrColumnWidth[18] = "0";
                    }
                }
            }
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info59Data.Get_ItemGroupList";
            ...
            logParam.Add("CUR_MENU_ID", "Info59");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
