...
{
    public partial class Info07 : System.Web.UI.Page
    {
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Info07");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Info07");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "PLANT_NM", "REMARK1", "REMARK2", "USE_YN", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "KEY_HID" };
        ...
        public void GetData(string flag)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info07Data.Get_PlantList";
            ...
            logParam.Add("CUR_MENU_ID", "Info07");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
