...
{
    public partial class Info16_p03 : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    txtDate.Text = ds.Tables[0].Rows[0]["PROD_DT"].ToString();
                    txtNoworkTimeHour.Text = ds.Tables[0].Rows[0]["NOWORK_TIME_HOUR"].ToString();
                    txtNoworkTimeMin.Text = ds.Tables[0].Rows[0]["NOWORK_TIME_MIN"].ToString();
