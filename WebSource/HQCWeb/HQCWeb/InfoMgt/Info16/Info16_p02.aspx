<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info16_p02.aspx.cs" Inherits="HQCWeb.InfoMgt.Info16.Info16_p02" %>
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lbGetProdDt" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th><asp:Label ID="lbNoworkTime" runat="server"></asp:Label></th>
                    <td>
                        <asp:Label ID="lbGetNoworkTime" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
