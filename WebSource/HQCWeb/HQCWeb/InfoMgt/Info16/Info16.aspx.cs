...
{
    public partial class Info16 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "PROD_DT", "NOWORK_TIME" };
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Info16");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Info16");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "OCCUR_DT", "NOWORK_TYPE", "NOWORK_DT", "STOP_MIN", "REMARK1", "REMARK2", "USE_YN", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "NOWORK_TIME", "PROD_DT", "KEY_HID" };
        ...
        public void GetData(string flag)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info16Data.Get_NoworkList";
            ...
            logParam.Add("CUR_MENU_ID", "Info16");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
