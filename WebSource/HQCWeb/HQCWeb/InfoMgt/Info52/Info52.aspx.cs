...
{
    public partial class Info52 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "CAR_TYPE", "STN_CD", "WORK_SEQ" };
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Info52");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Info52");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "LINE_NM", "CAR_NM", "STN_NM", "CAR_TYPE", "STN_CD", "WORK_SEQ", "WORK_NM", "WORK_IF_NAME", "REMARK1", "REMARK2", "USE_YN", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "KEY_HID" };
        ...
        public void GetData(string flag)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info52Data.Get_HMCList";
            ...
            logParam.Add("CUR_MENU_ID", "Info52");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
        ...
        protected void ddlShopCd_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            script = $@" cLine = {jsData1}; cCar = {jsData2}; fn_Set_Line(); fn_Set_Car(); ";
        ...
        private void txtLineCd_SelectedIndexChanged()
        {
            ...
            script = $@" cCar = {jsData1}; fn_Set_Car(); ";
            ScriptManager.RegisterClientScriptBlock(Page, this.GetType(), "comboData", script, true);
        }
        #endregion
