<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info52_p03.aspx.cs" Inherits="HQCWeb.InfoMgt.Info52.Info52_p03" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PopupContent" runat="server">
    <script type="text/javascript">
        function fn_Validation() {
            ...
            if ($("#PopupContent_ddlShopCd").val() == "") {
                ...
                alert("공정을 선택하세요.");
                return false;
            } else if ($("#PopupContent_ddlWorkCd").val() == "") {
                alert("작업을 선택하세요.");
                return false;
            } else {
    ...
    <div class="popup_wrap" tabindex="0">
        <!--// Title -->
        <div class="title">
            <h1><asp:Label ID="lbTitle" runat="server">Info52</asp:Label> - <asp:Label ID="lbWorkName" runat="server"></asp:Label></h1>
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <th><b style="color:red;">*</b><asp:Label ID="lbWorkCd" runat="server"></asp:Label></th>
                    <td>
                        <asp:DropDownList ID="ddlWorkCd" runat="server"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <th><asp:Label ID="lbWorkIfName" runat="server"></asp:Label></th>
                    <td>
                        <asp:TextBox ID="txtWorkIfName" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
            ...
            <!-- Table //-->
                ...
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="ddlShopCd" EventName="Click" />
                    <asp:AsyncPostBackTrigger ControlID="ddlLineCd" EventName="Click" />
                    <asp:AsyncPostBackTrigger ControlID="ddlCarType" EventName="Click" />
                    <asp:AsyncPostBackTrigger ControlID="ddlStnCd" EventName="Click" />
                </Triggers>
            </asp:UpdatePanel>
