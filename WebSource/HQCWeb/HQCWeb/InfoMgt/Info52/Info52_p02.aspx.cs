...
{
    public partial class Info52_p02 : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info52Data.Get_HMCInfo";
            ...
            // 상세조회 비지니스 메서드 호출
            ds = biz.GetList(strDBName, strQueryID, sParam);

            if (ds.Tables.Count > 0)
            {

                GetDDL(ds.Tables[0].Rows[0]["SHOP_CD"].ToString(), ds.Tables[0].Rows[0]["LINE_CD"].ToString(), ds.Tables[0].Rows[0]["CAR_TYPE"].ToString(), ds.Tables[0].Rows[0]["STN_CD"].ToString());
                ddlWorkCd.SelectedValue = ds.Tables[0].Rows[0]["WORK_CD"].ToString();
                txtWorkIfName.Text = ds.Tables[0].Rows[0]["WORK_IF_NAME"].ToString();
            ...
            {
                strScript = " alert('정보가 존재하지 않습니다. 관리자에게 문의바립니다.'); parent.fn_ModalReloadCall('Info52'); parent.fn_ModalCloseDiv(); ";
        ...
        protected void btnModify_Click(object sender, EventArgs e)
        {
            ...
            if (su.SetControlValChk(this.Page.Master, "PopupContent"))
            {
                ...
                sParam.Add("CUR_MENU_ID", "Info52");       // 조회페이지 메뉴 아이디 입력
                ...
                if (iRtn == 1)
                {
                    ...
                    strScript = " alert('정상수정 되었습니다.');  parent.fn_ModalReloadCall('Info52'); parent.fn_ModalCloseDiv(); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
                else
                {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (su.SetControlValChk(this.Page.Master, "PopupContent"))
            {
                ...
                {
                    strDBName = "GPDB";
                    strQueryID = "Info52Data.Set_HMCInfoDel";
                    ...
                    if (iRtn == 1)
                    {
                        ...
                        strScript = " alert('정상삭제 되었습니다.');  parent.fn_ModalReloadCall('Info52'); parent.fn_ModalCloseDiv(); ";
                        ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                    }
                    else
                    {
                ...
                {
                    strScript = " alert('이미 정보가 존재하지 않습니다.'); parent.fn_ModalReloadCall('Info52'); parent.fn_ModalCloseDiv(); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
            }
            else
        ...
        protected void btnRestore_Click(object sender, EventArgs e)
        {
            ...
            if (su.SetControlValChk(this.Page.Master, "PopupContent"))
            {
                ...
                if (iRtn == 1)
                {
                    ...
                    strScript = " alert('정상복구 되었습니다.');  parent.fn_ModalReloadCall('Info52'); parent.fn_ModalCloseDiv(); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
                else
                {
        ...
        #region GetDDL
        protected void GetDDL(string shopCd, string lineCd, string carType, string stnCd )
        {
