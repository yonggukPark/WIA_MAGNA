<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info12_p02.aspx.cs" Inherits="HQCWeb.InfoMgt.Info12.Info12_p02" %>
    ...
    <div class="popup_wrap" tabindex="0">
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <th><asp:Label ID="lbAlmNo" runat="server"></asp:Label></th>
                    <td>
                        <asp:Label ID="lbGetAlmNo" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
