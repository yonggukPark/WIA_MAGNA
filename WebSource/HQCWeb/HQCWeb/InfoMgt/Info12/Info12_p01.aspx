<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info12_p01.aspx.cs" Inherits="HQCWeb.InfoMgt.Info12.Info12_p01" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PopupContent" runat="server">
    <script type="text/javascript">
        function fn_Validation() {
            ...
            if ($("#PopupContent_ddlShopCd").val() == "") {
                ...
                alert("라인을 선택하세요.");
                return false;
            } else if ($("#PopupContent_txtAlmNo").val() == "") {
                alert("알람번호를 입력하세요.");
                return false;
            } else {
        ...
        $(document).ready(function () {
            ...
            $("#PopupContent_txtAlmNo").on('input', function () {
            ...
            $("#PopupContent_txtAlmAddr").on('input', function () {
                if ($(this).val().length > 4) {
                    $(this).val($(this).val().slice(0, 4));
                }
                else if (replaceNotInt.test($(this).val()))
    ...
    <div class="popup_wrap" tabindex="0">
        <!--// Title -->
        <div class="title">
            <h1><asp:Label ID="lbTitle" runat="server">Info12</asp:Label> - <asp:Label ID="lbWorkName" runat="server"></asp:Label></h1>
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <th><b style="color:red;">*</b><asp:Label ID="lbAlmNo" runat="server"></asp:Label></th>
                    <td>
                        <asp:TextBox ID="txtAlmNo" runat="server" type="number"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th><asp:Label ID="lbAlmAddr" runat="server"></asp:Label></th>
                    <td>
                        <asp:TextBox ID="txtAlmAddr" runat="server" type="number"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <th><asp:Label ID="lbAlmMsg" runat="server"></asp:Label></th>
                    <td>
                        <asp:TextBox ID="txtAlmMsg" runat="server" TextMode="MultiLine" MaxLength="100"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <th><asp:Label ID="lbAlmLevel" runat="server"></asp:Label></th>
                    <td>
                        <asp:DropDownList ID="ddlAlmLevel" runat="server"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
