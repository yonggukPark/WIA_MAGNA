...
namespace HQCWeb.InfoMgt.Info12
{
    public partial class Info12_p02 : System.Web.UI.Page
    {
        ...
        // 비지니스 클래스 작성
        Biz.InfoManagement.Info12 biz = new Biz.InfoManagement.Info12();
        ...
        private void SetTitle()
        {
            ...
            lbAlmNo.Text = Dictionary_Data.SearchDic("ALM_NO", bp.g_language);
            lbStnCd.Text = Dictionary_Data.SearchDic("STN_CD", bp.g_language);
            lbAlmAddr.Text = Dictionary_Data.SearchDic("ALM_ADDR", bp.g_language);
            lbAlmMsg.Text = Dictionary_Data.SearchDic("ALM_MSG", bp.g_language);
            lbAlmLevel.Text = Dictionary_Data.SearchDic("ALM_LEVEL", bp.g_language);
        ...
        protected void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info12Data.Get_AlarmInfo";
            ...
            sParam.Add("ALM_NO", strSplitValue[3].ToString());

            sParam.Add("CUR_MENU_ID", "Info12");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                lbGetAlmNo.Text = ds.Tables[0].Rows[0]["ALM_NO"].ToString();
                txtAlmAddr.Text = ds.Tables[0].Rows[0]["ALM_ADDR"].ToString();
                txtAlmMsg.Text = ds.Tables[0].Rows[0]["ALM_MSG"].ToString();
                ddlAlmLevel.SelectedValue = ds.Tables[0].Rows[0]["ALM_LEVEL"].ToString();
                ...
                if (ds.Tables[0].Rows[0]["DEL_YN"].ToString().Equals("Y"))
                {
                    ...
                    txtAlmAddr.Enabled = false;
                    txtAlmMsg.Enabled = false;
                    ddlAlmLevel.Enabled = false;
                ...
                else
                {
                    ...
                    txtAlmAddr.Enabled = true;
                    txtAlmMsg.Enabled = true;
                    ddlAlmLevel.Enabled = true;
            ...
            {
                strScript = " alert('정보가 존재하지 않습니다. 관리자에게 문의바립니다.'); parent.fn_ModalReloadCall('Info12'); parent.fn_ModalCloseDiv(); ";
        ...
        protected void btnModify_Click(object sender, EventArgs e)
        {
            ...
            if (su.SetControlValChk(this.Page.Master, "PopupContent"))
            {
                ...
                strDBName = "GPDB";
                strQueryID = "Info12Data.Set_AlarmInfo";
                ...
                sParam.Add("ALM_NO", strSplitValue[3].ToString());
                sParam.Add("ALM_ADDR", txtAlmAddr.Text);
                sParam.Add("ALM_MSG", txtAlmMsg.Text);
                sParam.Add("ALM_LEVEL", ddlAlmLevel.SelectedValue);
                ...
                if (iRtn == 1)
                {
                    ...
                    strScript = " alert('정상수정 되었습니다.');  parent.fn_ModalReloadCall('Info12'); parent.fn_ModalCloseDiv(); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
                else
                {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                strDBName = "GPDB";
                strQueryID = "Info12Data.Set_AlarmInfoDel";
                ...
                if (iRtn == 1)
                {
                    ...
                    strScript = " alert('정상삭제 되었습니다.');  parent.fn_ModalReloadCall('Info12'); parent.fn_ModalCloseDiv(); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
                else
                {
            ...
            {
                strScript = " alert('이미 정보가 존재하지 않습니다.'); parent.fn_ModalReloadCall('Info12'); parent.fn_ModalCloseDiv(); ";
                ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
            }
        }
        #endregion
        ...
        protected void btnRestore_Click(object sender, EventArgs e)
        {
            ...
            if (su.SetControlValChk(this.Page.Master, "PopupContent"))
            {
                ...
                if (iRtn == 1)
                {
                    ...
                    strScript = " alert('정상복원 되었습니다.');  parent.fn_ModalReloadCall('Info12'); parent.fn_ModalCloseDiv(); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
                else
                {
        ...
        protected void GetDDL(string shopCd, string lineCd)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info12Data.Get_DdlData";
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                {
                    ddlAlmLevel.Items.Add(new ListItem(ds.Tables[3].Rows[i]["CODE_NM"].ToString(), ds.Tables[3].Rows[i]["CODE_ID"].ToString()));
                }
