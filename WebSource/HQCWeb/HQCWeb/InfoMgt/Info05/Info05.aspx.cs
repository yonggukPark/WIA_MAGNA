...
{
    public partial class Info05 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "PART_NO", "CAR_TYPE" };
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Info05");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Info05");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "PART_NO", "CAR_TYPE", "PART_DESC", "CARD_CD", "CARD_DESC", "PART_TYPE", "Quantity", "REMARK1", "REMARK2", "USE_YN", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "KEY_HID" };
        ...
        public void GetData(string flag)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info05Data.Get_PartList";
            ...
            // 조회이력 저장용 파라미터
            param.Add("CUR_MENU_ID", "Info05");     // 조회페이지 메뉴 아이디 입력
            ...
            logParam.Add("CUR_MENU_ID", "Info05");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요

            btnlog.SetCUD(strDBName, "ButtonStatisticsData.Set_ButtonHisInfo", logParam);// 버튼로그 저장

            // 비지니스 메서드 호출
            ds = biz.GetPartList(strDBName, strQueryID, param);
