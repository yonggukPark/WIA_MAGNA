...
namespace HQCWeb.InfoMgt.Info10
{
    public partial class Info10_p03 : System.Web.UI.Page
    {
        ...
        // 비지니스 클래스 작성
        Biz.InfoManagement.Info10 biz = new Biz.InfoManagement.Info10();
        ...
        private void SetCon()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info10Data.Get_DdlData";
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                {
                    ddlIftype.Items.Add(new ListItem(ds.Tables[4].Rows[i]["CODE_NM"].ToString(), ds.Tables[4].Rows[i]["CODE_ID"].ToString()));
                }
        ...
        private void SetTitle()
        {
            ...
            lbDevKind.Text = Dictionary_Data.SearchDic("DEV_KIND", bp.g_language);
            lbIfType.Text = Dictionary_Data.SearchDic("IF_TYPE", bp.g_language);
            lbIfAddr.Text = Dictionary_Data.SearchDic("IF_ADDR", bp.g_language);
            lbPortNo.Text = Dictionary_Data.SearchDic("PORT_NO", bp.g_language);
            lbPlcName.Text = Dictionary_Data.SearchDic("PLC_NAME", bp.g_language);
        ...
        protected void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info10Data.Get_DevInfo";
            ...
            sParam.Add("CUR_MENU_ID", "Info10");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                txtDevKind.Text = ds.Tables[0].Rows[0]["DEV_KIND"].ToString();
                ddlIftype.SelectedValue = ds.Tables[0].Rows[0]["IF_TYPE"].ToString();
                txtIfAddr.Text = ds.Tables[0].Rows[0]["IP_ADDR"].ToString();
                txtPortNo.Text = ds.Tables[0].Rows[0]["PORT_NO"].ToString();
                txtPlcName.Text = ds.Tables[0].Rows[0]["PLC_NAME"].ToString();
            ...
            {
                strScript = " alert('정보가 존재하지 않습니다. 관리자에게 문의바립니다.'); parent.fn_ModalReloadCall('Info10'); parent.fn_ModalCloseDiv(); ";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (su.SetControlValChk(this.Page.Master, "PopupContent"))
            {
                ...
                strDBName = "GPDB";
                strQueryID = "Info10Data.Get_DevID_ValChk";
                ...
                sParamIDChk.Add("DEV_ID", txtDevId.Text);
                sParamIDChk.Add("CAR_TYPE", "");
                ...
                {
                    strDBName = "GPDB";
                    strQueryID = "Info10Data.Set_DevInfo";
                    ...
                    sParam.Add("DEV_ID", txtDevId.Text);
                    sParam.Add("CAR_TYPE", "");
                    //sParam.Add("CAR_TYPE", ddlCarType.SelectedValue);
                    sParam.Add("DEV_NM", txtDevNm.Text);
                    sParam.Add("STN_CD", ddlStnCd.SelectedValue);
                    sParam.Add("DEV_KIND", txtDevKind.Text);
                    sParam.Add("IF_TYPE", ddlIftype.SelectedValue);
                    sParam.Add("IP_ADDR", txtIfAddr.Text);
                    sParam.Add("PORT_NO", txtPortNo.Text);
                    sParam.Add("PLC_NAME", txtPlcName.Text);
                    ...
                    if (iRtn == 1)
                    {
                        strScript = " alert('정상등록 되었습니다.');  parent.fn_ModalReloadCall('Info10'); parent.fn_ModalCloseDiv(); ";
                        ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                    }
                    else
                    {
        ...
        protected void GetDDL(string shopCd, string lineCd)
        {
            ...
            //ddlCarType.Items.Add(new ListItem("", ""));
            ddlStnCd.Items.Add(new ListItem("", ""));
            ddlIftype.Items.Add(new ListItem("", ""));
