...
{
    public partial class Info10 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "DEV_ID", "CAR_TYPE" };
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Info10");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Info10");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "DEV_ID", "DEV_NM", "STN_CD", "IF_TYPE", "DEV_KIND", "IP_ADDR", "PORT_NO", "PLC_NAME", "REMARK1", "REMARK2", "USE_YN", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "KEY_HID" };
        ...
        private void SetTitle()
        {
            ...
            //lbLocCd.Text = Dictionary_Data.SearchDic("LOC_CD", bp.g_language);
        }
        #endregion
        ...
        public void GetData(string flag)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info10Data.Get_DevList";
            ...
            logParam.Add("CUR_MENU_ID", "Info10");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
