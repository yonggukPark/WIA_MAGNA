<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info17_p03.aspx.cs" Inherits="HQCWeb.InfoMgt.Info17.Info17_p03" %>
    ...
    <script type="text/javascript">
        function fn_Validation() {
            ...
            if ($("#PopupContent_ddlShopCd").val() == "") {
                ...
                alert("장비를 선택하세요.");
                return false;
            } else if ($("#PopupContent_ddlFldCd").val() == "") {
                alert("품질항목을 선택하세요.");
                return false;
            } else if ($("#PopupContent_txtLCL").val() == "") {
                alert("하한값을 입력하세요.");
                return false;
    ...
    <div class="popup_wrap" tabindex="0">
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <asp:UpdatePanel runat="server" ID="UpdatePanel2" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlStnCd" runat="server" OnSelectedIndexChanged="ddlStnCd_ddlCarType_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="ddlShopCd" EventName="SelectedIndexChanged" />
                    ...
                    <td>
                        <asp:UpdatePanel runat="server" ID="UpdatePanel3" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlCarType" runat="server" OnSelectedIndexChanged="ddlStnCd_ddlCarType_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="ddlShopCd" EventName="SelectedIndexChanged" />
                                <asp:AsyncPostBackTrigger ControlID="ddlLineCd" EventName="SelectedIndexChanged" />
                ...
                <tr>
                    <th><b style="color:red;">*</b><asp:Label ID="lbFldCd" runat="server"></asp:Label></th>
                    <td>
