...
{
    public partial class Info54_p02 : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    lbGetInsertTable.Text = ds.Tables[0].Rows[0]["INSERT_TABLE"].ToString();
                    lbGetItemSeq.Text = ds.Tables[0].Rows[0]["ITEM_SEQ"].ToString();
                    ...
                    if (ds.Tables[0].Rows[0]["DEL_YN"].ToString().Equals("Y"))
                    {
                        ...
                        txtItemMin.Enabled = false;
                        txtItemMax.Enabled = false;
                        txtHkmcTransInsItemNm.Enabled = false;
                        txtWorkCd.Enabled = false;
                        txtShopCdT.Enabled = false;
                        txtLineCdT.Enabled = false;
                        txtCarTypeT.Enabled = false;
                        txtPSet.Enabled = false;
                        txtResultLoc.Enabled = false;
                        txtHkmcCompany.Enabled = false;
                        txtHkmcRegion.Enabled = false;
                        txtHkmcSupplier.Enabled = false;
                        txtHkmcShop.Enabled = false;
                        txtHkmcLine.Enabled = false;
                        txtHkmcCarType.Enabled = false;
                        txtToolCnt.Enabled = false;
                        ddlPdaChkYn.Enabled = false;
                    ...
                    else
                    {
                        ...
                        txtItemNm.Enabled = true;
                        txtItemMin.Enabled = true;
                        txtItemMax.Enabled = true;
                        txtHkmcTransInsItemNm.Enabled = true;
                        txtWorkCd.Enabled = true;
                        txtShopCdT.Enabled = true;
                        txtLineCdT.Enabled = true;
                        txtCarTypeT.Enabled = true;
                        txtPSet.Enabled = true;
                        txtResultLoc.Enabled = true;
                        txtHkmcCompany.Enabled = true;
                        txtHkmcRegion.Enabled = true;
                        txtHkmcSupplier.Enabled = true;
                        txtHkmcShop.Enabled = true;
                        txtHkmcLine.Enabled = true;
                        txtHkmcCarType.Enabled = true;
                        txtToolCnt.Enabled = true;
                        ddlPdaChkYn.Enabled = true;
        ...
        protected void btnModify_Click(object sender, EventArgs e)
        {
            ...
            if (su.SetControlValChk(this.Page.Master, "PopupContent"))
            {
                ...
                if (iRtn == 1)
                {
                    ...
                    strScript = " alert('정상수정 되었습니다.');  parent.fn_ModalReloadCall('Info54'); parent.fn_ModalCloseDiv(); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
                else
                {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                strDBName = "GPDB";
                strQueryID = "Info54Data.Set_IFInfoDel";
                ...
                if (iRtn == 1)
                {
                    ...
                    strScript = " alert('정상삭제 되었습니다.');  parent.fn_ModalReloadCall('Info54'); parent.fn_ModalCloseDiv(); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
                else
                {
            ...
            {
                strScript = " alert('이미 정보가 존재하지 않습니다.'); parent.fn_ModalReloadCall('Info54'); parent.fn_ModalCloseDiv(); ";
                ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
            }
        }
        #endregion
        ...
        protected void btnRestore_Click(object sender, EventArgs e)
        {
            ...
            if (iRtn == 1)
            {
                ...
                strScript = " alert('정상복원 되었습니다.');  parent.fn_ModalReloadCall('Info54'); parent.fn_ModalCloseDiv(); ";
                ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
            }
            else
            {
