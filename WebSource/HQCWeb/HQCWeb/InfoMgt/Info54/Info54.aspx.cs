...
{
    public partial class Info54 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "STN_CD", "DEV_ID", "DEV_CHK", "INSERT_TABLE", "CAR_TYPE", "ITEM_SEQ" };
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Info54");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Info54");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_NM", "STN_NM", "DEV_ID", "DEV_CHK", "INSERT_TABLE", "CAR_TYPE", "ITEM_CD", "ITEM_NM", "ITEM_SEQ", "ITEM_MIN", "ITEM_MAX", "HKMC_TRANS_INS_ITEM_NM", "WORK_CD", "SHOP_CD_T", "LINE_CD_T", "CAR_TYPE_T", "P_SET", "RESULT_LOC", "HKMC_COMPANY", "HKMC_REGION", "HKMC_SUPPLIER", "HKMC_SHOP", "HKMC_LINE", "HKMC_CAR_TYPE", "PDA_CHK_YN", "TOOL_CNT", "REMARK1", "REMARK2", "USE_YN", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "LINE_CD", "STN_CD", "KEY_HID" };
        ...
        public void GetData(string flag)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info54Data.Get_IFList";
            ...
            logParam.Add("CUR_MENU_ID", "Info54");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
        ...
        protected void ddlShopCd_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            script = $@" cLine = {jsData1}; fn_Set_Line(); cCarType = {jsData2}; fn_Set_CarType(); ";
