<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Info54.aspx.cs" Inherits="HQCWeb.InfoMgt.Info54.Info54" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        function fn_Register() {
            fn_OpenPop('InfoMgt/Info54/Info54_p01.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
        }

        function fn_Modify(pkCode) {
            fn_PostOpenPop(pkCode, 'InfoMgt/Info54/Info54_p02.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
        }

        function fn_Copy() {
            if (currentValue != undefined)
                fn_PostOpenPop(currentValue, 'InfoMgt/Info54/Info54_p03.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
            else
        ...
        function settingGrid(_val) {
            ...
            gridView.columnByName("ITEM_SEQ").styleName = "grid-primary-column";

            gridView.columnByName("LINE_NM").styleName = "string-column";
            gridView.columnByName("STN_NM").styleName = "string-column";
            gridView.columnByName("INSERT_TABLE").styleName = "string-column";
            gridView.columnByName("ITEM_NM").styleName = "string-column";

            gridView.columnByName("RESULT_LOC").styleName = "number-column";
            gridView.columnByName("TOOL_CNT").styleName = "number-column";
    ...
    <div class="contents" tabindex="0">
        <!--// Title + Win_Btn -->
        <div class="title">
            <h3><asp:Label ID="lbTitle" runat="server">Info54</asp:Label></h3>
            <div class="al-r">
                ...
                <input type="button" value="Excel" id="btnExcel" runat="server" visible="false" onclick="fn_excelExport('Info54'); return false;" />
                        ...
                        <tr>
                            <td>
                                <div class="toolbar">
                                    ...
                                    <input type="button" value="Set" id="btnSet" onclick="getCol('Info54'); return false;" style="display:none; margin-top:10px; float:left" />
