<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info63_p01.aspx.cs" Inherits="HQCWeb.InfoMgt.Info63.Info63_p01" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PopupContent" runat="server">
    <script type="text/javascript">
        function fn_Validation() {
            if ($("#PopupContent_txtDRespCd").val() == "") {
                alert("귀책처코드를 입력하세요.");
                return false;
            } else {
    ...
    <div class="popup_wrap" tabindex="0">
        <!--// Title -->
        <div class="title">
            <h1><asp:Label ID="lbTitle" runat="server">Info63</asp:Label> - <asp:Label ID="lbWorkName" runat="server"></asp:Label></h1>
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtDRespCd" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <th><asp:Label ID="lbDRespNm" runat="server"></asp:Label></th>
                    <td>
                        <asp:TextBox ID="txtDRespNm" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
