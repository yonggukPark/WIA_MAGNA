...
{
    public partial class Info47_p03 : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                txtLineGroupCd.Text = ds.Tables[0].Rows[0]["LINE_GROUP_CD"].ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (su.SetControlValChk(this.Page.Master, "PopupContent"))
            {
                ...
                strDBName = "GPDB";
                strQueryID = "Info47Data.Get_LineGrpID_ValChk";

                FW.Data.Parameters sParamIDChk = new FW.Data.Parameters();
                sParamIDChk.Add("PLANT_CD", ddlPlantCd.SelectedValue);
                sParamIDChk.Add("LINE_GROUP_CD", txtLineGroupCd.Text);

                // 아이디 체크 비지니스 메서드 작성
                strRtn = biz.GetLineGrpValChk(strDBName, strQueryID, sParamIDChk);
                if (strRtn == "0")
                {
                    strDBName = "GPDB";
                    ...
                    sParam.Add("LINE_GROUP_CD", txtLineGroupCd.Text);
                    ...
                    if (iRtn == 1)
                    {
                        strScript = " alert('정상등록 되었습니다.');  parent.fn_ModalReloadCall('Info47'); parent.fn_ModalCloseDiv(); ";
                        ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                    }
                    else
                    {
