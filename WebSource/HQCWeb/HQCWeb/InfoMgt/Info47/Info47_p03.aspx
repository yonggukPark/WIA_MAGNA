<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info47_p03.aspx.cs" Inherits="HQCWeb.InfoMgt.Info47.Info47_p03" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PopupContent" runat="server">
    <script type="text/javascript">
        function fn_Validation() {
            ...
            if ($("#PopupContent_ddlPlantCd").val() == "") {
                alert("공장코드를 선택하세요.");
                return false;
            } else if ($("#PopupContent_txtLineGroupCd").val() == "") {
                alert("라인그룹코드를 입력하세요.");
                return false;
            } else {
    ...
    <div class="popup_wrap" tabindex="0">
        <!--// Title -->
        <div class="title">
            <h1><asp:Label ID="lbTitle" runat="server">Info47</asp:Label> - <asp:Label ID="lbWorkName" runat="server"></asp:Label></h1>
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <th><b style="color:red;">*</b><asp:Label ID="lbLineGroupCd" runat="server"></asp:Label></th>
                    <td>
                        <asp:TextBox ID="txtLineGroupCd" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <th><asp:Label ID="lbLineGroupNm" runat="server"></asp:Label></th>
                    <td>
                        <asp:TextBox ID="txtLineGroupNm" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
