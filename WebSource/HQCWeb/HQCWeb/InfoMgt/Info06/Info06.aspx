<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Info06.aspx.cs" Inherits="HQCWeb.InfoMgt.Info06.Info06" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        function fn_Register() {
            fn_OpenPop('InfoMgt/Info06/Info06_p01.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
        }

        function fn_Modify(pkCode) {
            fn_PostOpenPop(pkCode, 'InfoMgt/Info06/Info06_p02.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
        }

        function fn_Copy() {
            if (currentValue != undefined)
                fn_PostOpenPop(currentValue, 'InfoMgt/Info06/Info06_p03.aspx', $("#MainContent_hidWidth").val(), $("#MainContent_hidHeight").val());
            else
        ...
        function settingGrid(_val) {
            ...
            gridView.columnByName("STN_CD").styleName = "grid-primary-column"
            ...
            gridView.setColumnProperty("PLANT_CD", "mergeRule", { criteria: "value" });//병합 설정
            gridView.setColumnProperty("SHOP_CD", "mergeRule", { criteria: "value" });//병합 설정
            gridView.setColumnProperty("LINE_CD", "mergeRule", { criteria: "value" });//병합 설정
            gridView.setColumnProperty("LINE_NM", "mergeRule", { criteria: "value" });//병합 설정
    ...
    <asp:HiddenField ID="hidWidth" runat="server" Value="850" />
    <asp:HiddenField ID="hidHeight" runat="server" Value="500" />

    <div class="contents" tabindex="0">
        <!--// Title + Win_Btn -->
        <div class="title">
            <h3><asp:Label ID="lbTitle" runat="server">Info06</asp:Label></h3>
            <div class="al-r">
                ...
                <input type="button" value="Excel" id="btnExcel" runat="server" visible="false" onclick="fn_excelExport('Info06'); return false;" />
            </div>
        </div>
        <!-- Title + Win_Btn //-->
        <!--// Grid Search -->
                        ...
                        <tr>
                            <td>
                                <div class="toolbar">
                                    ...
                                    <input type="button" value="Set" id="btnSet" onclick="getCol('Info06'); return false;" style="display:none; margin-top:10px; float:left" />
