...
{
    public partial class Info06 : System.Web.UI.Page
    {
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID", "Info06");
            sParam.Add("USER_ID", bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID", "Info06");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "LINE_NM", "STN_CD", "STN_NM", "NG_CD", "MULTIPLI", "REINPUT", "FINISH", "COM_PROD", "TORQUE", "INSPECTION", "INPUT", "MERGE_STN_CD", "REWORK_STN_CD", "P_R_STN_CD", "TOTAL_STN_CD", "REINPUT_STN_CD", "VIEW_YN", "USE_YN", "REMARK1", "REMARK2", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "KEY_HID" };
                        ...
                        arrColumnWidth[4] = "80";
                        arrColumnWidth[5] = "192";
                        arrColumnWidth[6] = "49";
                        arrColumnWidth[7] = "80";
                        arrColumnWidth[8] = "80";
                        arrColumnWidth[9] = "80";
                        arrColumnWidth[10] = "80";
                        arrColumnWidth[11] = "80";
                        arrColumnWidth[12] = "80";
                        arrColumnWidth[13] = "80";
                        arrColumnWidth[14] = "80";
                        arrColumnWidth[15] = "80";
                        arrColumnWidth[16] = "80";
                        arrColumnWidth[17] = "80";
                        arrColumnWidth[18] = "93";
                        arrColumnWidth[19] = "54";
                        arrColumnWidth[20] = "54";
                        arrColumnWidth[21] = "200";
                        arrColumnWidth[22] = "200";
                        arrColumnWidth[23] = "129";
                        arrColumnWidth[24] = "200";
                        arrColumnWidth[25] = "129";
        ...
        public void GetData(string flag)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info06Data.Get_StnList";
            ...
            logParam.Add("CUR_MENU_ID", "Info06");             // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
