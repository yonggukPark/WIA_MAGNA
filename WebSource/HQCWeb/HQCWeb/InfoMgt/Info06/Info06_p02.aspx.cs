    ...
    public partial class Info06_p02 : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                txtReinputStnCd.Text       = ds.Tables[0].Rows[0]["REINPUT_STN_CD"].ToString();
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (su.SetControlValChk(this.Page.Master, "PopupContent"))
            {
                ...
                {
                    strScript = " alert('이미 정보가 존재하지 않습니다.'); parent.fn_ModalReloadCall('Info06'); parent.fn_ModalCloseDiv(); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
            }
            else
