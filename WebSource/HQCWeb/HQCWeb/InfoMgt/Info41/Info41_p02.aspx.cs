...
namespace HQCWeb.InfoMgt.Info41
{
    public partial class Info41_p02 : System.Web.UI.Page
    {
        ...
        // 비지니스 클래스 작성
        Biz.InfoManagement.Info41 biz = new Biz.InfoManagement.Info41();
        ...
        private void SetCon()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info41Data.Get_DdlData";
        ...
        private void SetTitle()
        {
            ...
            lbVendorCd.Text = Dictionary_Data.SearchDic("VENDOR_CD", bp.g_language);
            lbVendorNm.Text = Dictionary_Data.SearchDic("VENDOR_NM", bp.g_language);
        ...
        protected void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info41Data.Get_VendorInfo";

            FW.Data.Parameters sParam = new FW.Data.Parameters();
            sParam.Add("PLANT_CD", strSplitValue[0].ToString());
            sParam.Add("VENDOR_CD", strSplitValue[1].ToString());

            sParam.Add("CUR_MENU_ID", "Info41");        // 조회페이지 메뉴 아이디 입력 - 에러로그 생성시 메뉴 아이디 필요
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                {
                    lbGetVendorCd.Text = ds.Tables[0].Rows[0]["VENDOR_CD"].ToString();
                    txtVendorNm.Text = ds.Tables[0].Rows[0]["VENDOR_NM"].ToString();
            ...
            {
                strScript = " alert('정보가 존재하지 않습니다. 관리자에게 문의바립니다.'); parent.fn_ModalReloadCall('Info41'); parent.fn_ModalCloseDiv(); ";
                ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
            }
        }
        #endregion
        ...
        protected void btnModify_Click(object sender, EventArgs e)
        {
            ...
            if (su.SetControlValChk(this.Page.Master, "PopupContent"))
            {
                ...
                strDBName = "GPDB";
                strQueryID = "Info41Data.Set_VendorInfo";

                FW.Data.Parameters sParam = new FW.Data.Parameters();
                sParam.Add("PLANT_CD", strSplitValue[0].ToString());
                sParam.Add("VENDOR_CD", strSplitValue[1].ToString());

                sParam.Add("VENDOR_NM", txtVendorNm.Text);
                ...
                if (iRtn == 1)
                {
                    ...
                    strScript = " alert('정상수정 되었습니다.');  parent.fn_ModalReloadCall('Info41'); parent.fn_ModalCloseDiv(); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
                else
                {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            { 
                ...
                strDBName = "GPDB";
                strQueryID = "Info41Data.Set_VendorInfoDel";
                ...
                if (iRtn == 1)
                {
                    ...
                    strScript = " alert('정상삭제 되었습니다.');  parent.fn_ModalReloadCall('Info41'); parent.fn_ModalCloseDiv(); ";
                    ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
                }
                else
                {
            ...
            {
                strScript = " alert('이미 정보가 존재하지 않습니다.'); parent.fn_ModalReloadCall('Info41'); parent.fn_ModalCloseDiv(); ";
                ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
            }
        }
        #endregion
        ...
        protected void btnRestore_Click(object sender, EventArgs e)
        {
            ...
            if (iRtn == 1)
            {
                ...
                strScript = " alert('정상복원 되었습니다.');  parent.fn_ModalReloadCall('Info41'); parent.fn_ModalCloseDiv(); ";
                ClientScript.RegisterStartupScript(typeof(string), Guid.NewGuid().ToString(), strScript, true);
            }
            else
            {
