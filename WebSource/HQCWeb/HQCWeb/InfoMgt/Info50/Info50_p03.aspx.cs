...
{
    public partial class Info50_p03 : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                {
                    ddlErrorCd.SelectedValue = ds.Tables[0].Rows[0]["ERROR_CD"].ToString();
                    txtErrorSCd.Text = ds.Tables[0].Rows[0]["ERROR_S_CD"].ToString();
