<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info50_p02.aspx.cs" Inherits="HQCWeb.InfoMgt.Info50.Info50_p02" %>
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lbGetErrorCd" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <th><asp:Label ID="lbErrorSCd" runat="server"></asp:Label></th>
                    <td>
                        <asp:Label ID="lbGetErrorSCd" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
