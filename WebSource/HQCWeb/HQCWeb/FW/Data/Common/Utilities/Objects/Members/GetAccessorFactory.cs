...
namespace HQCWeb.FW.Data.Common.Utilities.Objects.Members
{
    /// <summary>
        ...
        public GetAccessorFactory(bool allowCodeGeneration)
		{
            if (allowCodeGeneration)
            {
                ...
                else
                {
                    ...
                    _assemblyBuilder = System.Reflection.Emit.AssemblyBuilder.DefineDynamicAssembly(assemblyName, AssemblyBuilderAccess.Run);
