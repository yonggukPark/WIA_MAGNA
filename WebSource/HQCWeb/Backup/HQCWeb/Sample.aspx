            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtFromDt" runat="server" Width="80" onkeydown="return fn_EventKeyChk(event);" onkeyup="removeChar(event);" style="IME-MODE:disabled; background-color:white; color:black;"></asp:TextBox> <span id="spBetween" style="display:none;">~</span>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <img src="img/gnb_on_arrow.png" style="float:left; padding-left:175px;" onclick="javascript:fn_SearchSetStyle();" />
