<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="PublicSplitSample.aspx.cs" Inherits="HQCWeb.Template.PublicSplitSample" %>
            ...
            <div class="tbl">
                ...
                <div id="divMainGrid">
                    <asp:UpdatePanel ID="upMain" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div id="realMaingrid" style="width: 100%; height: 440px;"></div>
                            <table>
                                <tr>
                                    <td>
                                        <div class="toolbar">
            ...
            <div class="tbl ml20">
                ...
                <div id="divDetailGrid">
                    ...
                    <asp:UpdatePanel ID="upDetail" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div id="realDetailgrid" style="width: 100%; height: 440px;"></div>
                        </ContentTemplate>
                        <Triggers>
