...
namespace HQCWeb.Biz.InfoManagement
{
    public class Info47
    {
        ...
        #region GetLineGrp
        public DataSet GetLineGrp(string strDBName, string strQueryID, Parameters sParam)
        {
        ...
        #region GetLineGrpValChk
        public string GetLineGrpValChk(string strDBName, string strQueryID, Parameters sParam)
        {
