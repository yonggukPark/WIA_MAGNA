...
namespace HQCWeb.Biz.InfoManagement
{
    public class Info19
    {
        ...
        #region GetWorkOrder
        public DataSet GetWorkOrder(string strDBName, string strQueryID, Parameters sParam)
        {
        ...
        #region GetWorkIDValChk
        public string GetWorkIDValChk(string strDBName, string strQueryID, Parameters sParam)
        {
