...
namespace HQCWeb.Biz.InfoManagement
{
    public class Info48
    {
        ...
        #region GetLineGrpMatch
        public DataSet GetLineGrpMatch(string strDBName, string strQueryID, Parameters sParam)
        {
        ...
        #region GetLineMatchValChk
        public string GetLineMatchValChk(string strDBName, string strQueryID, Parameters sParam)
        {
