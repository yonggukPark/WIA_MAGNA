...
namespace HQCWeb.Biz.Cell.Material
{
    public class OM_001_70
    {
        ...
        public DataSet GetLineList(string[] pValue)
        {
            ...
            jDoc = JsonUtils.MakeBaseMessage("OM_001_70.Get_LineList", "0", string.Empty);

            JsonUtils.AddTextNode(jDoc, "//message/body", "DBNAME",     strPlant);     // DB이름 : CELL, MODULE 둘중 한가지 입력
            JsonUtils.AddTextNode(jDoc, "//message/body", "QUERYID",    "OM_001_70.Get_LineList");
        ...
        public DataSet GetEquipmentList(string[] pValue)
        {
            ...
            jDoc = JsonUtils.MakeBaseMessage("OM_001_70.Get_EquipmentList", "0", string.Empty);

            JsonUtils.AddTextNode(jDoc, "//message/body", "DBNAME",     strPlant);     // DB이름 : CELL, MODULE 둘중 한가지 입력
            JsonUtils.AddTextNode(jDoc, "//message/body", "QUERYID",    "OM_001_70.Get_EquipmentList");
            JsonUtils.AddTextNode(jDoc, "//message/body", "QUERYTYPE",  "0");        // 0:조회,1:입력,2:수정,3:삭제
        ...
        #region GetSubEquipmentPartList
        public DataSet GetSubEquipmentPartList(string[] pValue)
        {
            DataSet dsList = new DataSet();
            DataTable dt = new DataTable();
            ...
            jDoc = JsonUtils.MakeBaseMessage("OM_001_70.Get_SubEquipmentPartList", "0", string.Empty);

            JsonUtils.AddTextNode(jDoc, "//message/body", "DBNAME",     strPlant);     // DB이름 : CELL, MODULE 둘중 한가지 입력
            JsonUtils.AddTextNode(jDoc, "//message/body", "QUERYID",    "OM_001_70.Get_SubEquipmentPartList");
            JsonUtils.AddTextNode(jDoc, "//message/body", "QUERYTYPE",  "0");        // 0:조회,1:입력,2:수정,3:삭제

            jParams = JsonUtils.AddObjectNode(jDoc, "//message/body", "PARAMS");
            JsonUtils.AddChildTextNode(jParams, "siteid",   pValue[0]);
            JsonUtils.AddChildTextNode(jParams, "part",     pValue[1]);
        ...
        #region GetHoleScreenUseHistList
        public DataSet GetHoleScreenUseHistList(string[] pValue)
        {
            DataSet dsList = new DataSet();
            DataTable dt = new DataTable();
            ...
            jDoc = JsonUtils.MakeBaseMessage("OM_001_70.Get_HoleScreenUseHistList", "0", string.Empty);

            JsonUtils.AddTextNode(jDoc, "//message/body", "DBNAME",     strPlant);     // DB이름 : CELL, MODULE 둘중 한가지 입력
            JsonUtils.AddTextNode(jDoc, "//message/body", "QUERYID",    "OM_001_70.Get_HoleScreenUseHistList");
            JsonUtils.AddTextNode(jDoc, "//message/body", "QUERYTYPE",  "0");        // 0:조회,1:입력,2:수정,3:삭제

            jParams = JsonUtils.AddObjectNode(jDoc, "//message/body", "PARAMS");
            JsonUtils.AddChildTextNode(jParams, "siteid",       pValue[0]);
            JsonUtils.AddChildTextNode(jParams, "line",         pValue[1]);
            JsonUtils.AddChildTextNode(jParams, "eqpid",        pValue[2]);
            JsonUtils.AddChildTextNode(jParams, "subeqpid",     pValue[3]);
            JsonUtils.AddChildTextNode(jParams, "startdate",    pValue[4]);
            JsonUtils.AddChildTextNode(jParams, "enddate",      pValue[5]);
