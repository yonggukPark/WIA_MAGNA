...
namespace HQCWeb.Biz.Cell.TagMgt
{
    public class OM_001_18
    {
        ...
        #region GetCarrierList
        public DataSet GetCarrierList(string[] pValue)
        {
            ...
            jDoc = JsonUtils.MakeBaseMessage("OM_001_18.Get_CarrierList", "0", string.Empty);

            JsonUtils.AddTextNode(jDoc, "//message/body", "DBNAME",     strPlant);     // DB이름 : CELL, MODULE 둘중 한가지 입력
            JsonUtils.AddTextNode(jDoc, "//message/body", "QUERYID",    "OM_001_18.Get_CarrierList");
        ...
        #region GetProductOrderList
        public DataSet GetProductOrderList(string[] pValue)
        {
            DataSet dsList = new DataSet();
            DataTable dt = new DataTable();
            ...
            jDoc = JsonUtils.MakeBaseMessage("OM_001_18.Get_ProductOrderList", "0", string.Empty);

            JsonUtils.AddTextNode(jDoc, "//message/body", "DBNAME",     strPlant);     // DB이름 : CELL, MODULE 둘중 한가지 입력
            JsonUtils.AddTextNode(jDoc, "//message/body", "QUERYID",    "OM_001_18.Get_ProductOrderList");
            JsonUtils.AddTextNode(jDoc, "//message/body", "QUERYTYPE",  "0");        // 0:조회,1:입력,2:수정,3:삭제
        ...
        #region GetProcessSegmentList
        public DataSet GetProcessSegmentList(string[] pValue)
        {
            DataSet dsList = new DataSet();
            DataTable dt = new DataTable();
            ...
            jDoc = JsonUtils.MakeBaseMessage("OM_001_18.Get_ProcessSegmentList", "0", string.Empty);

            JsonUtils.AddTextNode(jDoc, "//message/body", "DBNAME",     strPlant);     // DB이름 : CELL, MODULE 둘중 한가지 입력
            JsonUtils.AddTextNode(jDoc, "//message/body", "QUERYID",    "OM_001_18.Get_ProcessSegmentList");
            JsonUtils.AddTextNode(jDoc, "//message/body", "QUERYTYPE",  "0");        // 0:조회,1:입력,2:수정,3:삭제
        ...
        #region GetNextToolValueCodeList
        public DataSet GetNextToolValueCodeList(string[] pValue)
        {
            DataSet dsList = new DataSet();
            DataTable dt = new DataTable();
            ...
            jDoc = JsonUtils.MakeBaseMessage("OM_001_18.Get_NextToolValueCodeList", "0", string.Empty);

            JsonUtils.AddTextNode(jDoc, "//message/body", "DBNAME",     strPlant);     // DB이름 : CELL, MODULE 둘중 한가지 입력
            JsonUtils.AddTextNode(jDoc, "//message/body", "QUERYID",    "OM_001_18.Get_NextToolValueCodeList");
            JsonUtils.AddTextNode(jDoc, "//message/body", "QUERYTYPE",  "0");        // 0:조회,1:입력,2:수정,3:삭제
