...
using HQCWeb.FW.Data.Common.Utilities.TypesResolver;
using HQCWeb.FW.Data.Common.Xml;

#endregion

namespace HQCWeb.FW.Data.Common.Utilities
{
    /// <summary>
    ...
    public class Resources
    {
        ...
        #region Fields
        //private static string _applicationBase = AppDomain.CurrentDomain.BaseDirectory;// AppDomain.CurrentDomain.SetupInformation.ApplicationBase;
        //private static string _applicationBase = @"C:\svn\1-2.WEB\WebSource\HQCWeb\HQCWeb\bin\";
        //private static string _baseDirectory = AppDomain.CurrentDomain.BaseDirectory;
        //private static string _baseDirectory = @"C:\svn\1-2.WEB\WebSource\HQCWeb\HQCWeb\bin\";
        //private static CachedTypeResolver _cachedTypeResolver = null;
        
        private static string _applicationBase = System.Configuration.ConfigurationManager.AppSettings.Get("SQLMAPCONFIG_FILE_PATH");
        private static string _baseDirectory = System.Configuration.ConfigurationManager.AppSettings.Get("SQLMAPCONFIG_FILE_PATH");
        ...
        /// </exception>
        [Obsolete("Use HQCWeb.FW.Data.Common.Utilities.TypeUtils")]
