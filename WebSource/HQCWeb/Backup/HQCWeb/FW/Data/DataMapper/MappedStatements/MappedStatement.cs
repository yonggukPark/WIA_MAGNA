...
using HQCWeb.FW.Data.DataMapper.Commands;
using HQCWeb.FW.Data.DataMapper.Configuration.ParameterMapping;
using HQCWeb.FW.Data.DataMapper.Configuration.Statements;
using HQCWeb.FW.Data.DataMapper.MappedStatements.ResultStrategy;
using HQCWeb.FW.Data.DataMapper.Scope;
using HQCWeb.FW.Data.DataMapper.MappedStatements.PostSelectStrategy;
...
namespace HQCWeb.FW.Data.DataMapper.MappedStatements
{
    ...
    public class MappedStatement : IMappedStatement
    {
        ...
        ///<exception cref="HQCWeb.FW.Data.DataMapper.Exceptions.DataMapperException">If a transaction is not in progress, or the database throws an exception.</exception>
