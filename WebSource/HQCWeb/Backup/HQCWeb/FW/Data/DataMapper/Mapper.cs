...
namespace HQCWeb.FW.Data.DataMapper
{
	...
	public sealed class Mapper
	{
        ...
        public static string _processName = null;
        public static bool _activeLogging = false;
        #endregion
        ...
        public static ISqlMapper Instance(string p_processName, bool p_activeLogging)
        {
            _processName = p_processName;
            _activeLogging = p_activeLogging;
            if (_mapper == null)
            {
                lock (typeof(SqlMapper))
                {
