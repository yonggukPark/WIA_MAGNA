<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info48_p01.aspx.cs" Inherits="HQCWeb.InfoMgt.Info48.Info48_p01" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PopupContent" runat="server">
    <script type="text/javascript">
        function fn_Validation() {
            ...
            if ($("#PopupContent_ddlShopCd").val() == "") {
                ...
                alert("라인을 선택하세요.");
                return false;
            } else if ($("#PopupContent_ddlLineGroupCd").val() == "") {
                alert("라인그룹을 선택하세요.");
                return false;
            } else {
    ...
    <div class="popup_wrap">
        <!--// Title -->
        <div class="title">
            <h1><asp:Label ID="lbTitle" runat="server">Info48</asp:Label> - <asp:Label ID="lbWorkName" runat="server"></asp:Label></h1>
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlLineGroupCd" runat="server"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
