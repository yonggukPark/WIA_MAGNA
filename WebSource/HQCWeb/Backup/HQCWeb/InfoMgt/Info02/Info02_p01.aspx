<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Info02_p01.aspx.cs" Inherits="HQCWeb.InfoMgt.Info02.Info02_p01" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PopupContent" runat="server">
    <script type="text/javascript">
        function fn_Validation() {

            if ($("#PopupContent_txtCdGrp").val() == "") {
                alert("코드그룹을 입력하세요.");
                return false;
