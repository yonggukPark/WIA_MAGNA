...
namespace HQCWeb.InfoMgt.Info02
{
    public partial class Info02 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "CD_GRP", "CODE" };
        ...
        private void SetPageInit()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "CD_GRP", "CODE", "CD_NM", "CD_DESC1", "CD_DESC2", "CD_DESC3", "CD_DESC4", "CD_DESC5", "CD_DESC6", "CD_DESC7", "REMARK1", "REMARK2", "USE_YN", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "KEY_HID" };
        ...
        public void GetData(string flag)
        {
            ...
            strDBName = "GPDB";
            strQueryID = "Info02Data.Get_CdList";
