        ...
        private void SetPageInit()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "LINE_NM", "STN_CD", "STN_NM", "NG_CD", "MULTIPLI", "REINPUT", "FINISH", "COM_PROD", "TORQUE", "INSPECTION", "INPUT", "MERGE_STN_CD", "REWORK_STN_CD", "P_R_STN_CD", "TOTAL_STN_CD", "VIEW_YN", "USE_YN", "REMARK1", "REMARK2", "REG_DATE", "REG_USER", "MOD_DATE", "MOD_USER", "KEY_HID" };
