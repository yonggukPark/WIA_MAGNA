        ...
        private void SetPageInit()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "PROD_DT", "LINE_NM", "PART_NO", "RES_OK_SUM", "RES_TM00", "RES_TM01", "RES_TM02", "RES_TM03", "RES_TM04", "RES_TM05", "RES_TM06", "RES_TM07", "RES_TM08", "RES_TM09", "RES_TM10", "RES_TM11", "RES_TM12", "RES_TM13", "RES_TM14", "RES_TM15", "RES_TM16", "RES_TM17", "RES_TM18", "RES_TM19", "RES_TM20", "RES_TM21", "RES_TM22", "RES_TM23", "KEY_HID" };
