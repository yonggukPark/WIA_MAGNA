        ...
        private void SetPageInit()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_NM", "STN_CD", "SUM_PROD", "PROD_MONTH01", "PROD_MONTH02", "PROD_MONTH03", "PROD_MONTH04", "PROD_MONTH05", "PROD_MONTH06", "PROD_MONTH07", "PROD_MONTH08", "PROD_MONTH09", "PROD_MONTH10", "PROD_MONTH11", "PROD_MONTH12", "KEY_HID" };
