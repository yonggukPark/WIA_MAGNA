<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Res18.aspx.cs" Inherits="HQCWeb.ResultMgt.Res18.Res18" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        function settingGrid(_val) {
            ...
            var j = getDate($("#MainContent_txtMonth").val());

            for(var i = 31; i>j; i--)
                gridView.columnByName("PROD_DAY"+String(i).padStart(2,'0')).visible = false;
        ...
        function getDate(sMonth) {
            var sYear = String(sMonth).slice(0, 4);
            var sMonth = String(sMonth).slice(-2);
            var nDate = new Date(sYear, sMonth, 0).getDate();
    ...
    <script type="text/javascript">
        ...
        {   
            ...
            $("#MainContent_txtMonth").focus(function () {
    ...
    <div class="contents">
        <!--// Title + Win_Btn -->
        <div class="title">
            <h3><asp:Label ID="lbTitle" runat="server">Res18</asp:Label></h3>
        </div>
        <!-- Title + Win_Btn //-->
        <!--// Grid Search -->
        <div class="search_grid mt13">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtMonth" runat="server" Width="80" onkeydown="return fn_EventKeyChk(event);" onkeyup="removeChar(event);" style="IME-MODE:disabled; background-color:white; color:black;"></asp:TextBox> 
                    </td>
                    ...
                    <td class="al-r">
                        ...
                        <input type="button" value="Excel" id="btnExcel" runat="server" visible="false" onclick="fn_excelExport('Res18'); return false;" />
                    </td>
                </tr>
            </table>
        </div>
                        ...
                        <tr>
                            <td>
                                <div class="toolbar">
                                    ...
                                    <input type="button" value="Set" id="btnSet" onclick="getCol('Res18'); return false;" style="display:none; margin-top:2px;" />
                                </div>
                            </td>
                        </tr>
                    </table>
