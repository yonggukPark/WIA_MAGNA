...
{
    public partial class Notice003 : System.Web.UI.Page
    {
            ...
            if (ds.Tables.Count > 0)
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++) {
                        ...
                        strFileInfo += "<div style=\"width: 100px; height: 100px; float:left; text-align:center;\">" +
                                            "<a href=\"http://localhost/Notice/" + strFilePath + "/" + strChgFileName + "\" download=\"" + strOrgFileName + "\"><img src=\"/images/btn/" + strICon + "_80.png\" /></a>" +
                                            "<br />" +
