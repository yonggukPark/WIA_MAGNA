<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Widget002.aspx.cs" Inherits="HQCWeb.SystemMgt.WidgetManagement.Widget002" %>
    ...
    <div class="popup_wrap">
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <th><asp:Label ID="lbWidgetNum" runat="server"></asp:Label></th>
                    <td>
                        <asp:Label ID="lbGetWidgetNum" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
