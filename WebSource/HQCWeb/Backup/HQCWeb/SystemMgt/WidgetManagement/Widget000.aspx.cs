...
{
    public partial class Widget000 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "WIDGET_NUM" };
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID",       "WEB_00110");
            sParam.Add("USER_ID",       bp.g_userid.ToString());

            sParam.Add("CUR_MENU_ID",   "WEB_00110");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "WIDGET_NUM", "WIDGET_NM", "WIDGET_URL", "WIDGET_SIZE", "USE_YN", "REGIST_DATE", "REGIST_USER_ID", "MODIFY_DATE", "MODIFY_USER_ID", "KEY_HID" };
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "WidgetData.Get_WidgetList";
            ...
            // 비지니스 메서드 호출
            ds = biz.GetWidgetList(strDBName, strQueryID, sParam);
