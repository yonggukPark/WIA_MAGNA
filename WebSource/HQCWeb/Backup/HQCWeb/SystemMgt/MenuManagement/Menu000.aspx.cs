        ...
        private void SetPageInit()
        {
            ...
            if (ds.Tables.Count > 0) {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "MENU_ID", "MENU_NM", "MENU_PARENT_ID", "MENU_LEVEL", "MENU_IDX", "REGIST_DATE", "REGIST_USER_ID", "MODIFY_DATE", "MODIFY_USER_ID", "ASSEMBLY_ID", "VIEW_ID", "USE_YN", "APPROVAL_FLAG", "KEY_HID" };
