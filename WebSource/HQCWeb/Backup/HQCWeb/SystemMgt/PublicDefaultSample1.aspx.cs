...
{
    public partial class PublicDefaultSample1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //정상처리되면
            if (!String.IsNullOrEmpty(jsCol) && !String.IsNullOrEmpty(jsField))
            {
        ...
        {
            arrColumn = new string[] { "DIC_ID", "DIC_TXT_KR", "DIC_TXT_EN", "DIC_TXT_LO", "REGIST_DATE", "REGIST_USER_ID", "MODIFY_DATE", "MODIFY_USER_ID" };
        ...
        private void SetGridTitle()
        {
            ...
            jsCol = ConvertColArrToJSON(arrColumn, arrColumnCaption, arrColumnWidth, "cols");
            jsField = ConvertColArrToJSON(arrColumn, arrColumnCaption, arrColumnWidth, "fields");
        }
        #endregion
        ...
        public void GetData()
        {
            ...
            Biz.SystemManagement.PublicBizSample1 biz = new Biz.SystemManagement.PublicBizSample1();
            ...
            if (ds.Tables.Count > 0)
            {
               ...
               // grid.SetDataListToGrid(arrColumn, arrColumnCaption, arrColumnWidth, strKeyColumn, ds, arrHiddenColumn, arrMergeColumn);
                ...
                //realGrid 방식
                jsData = ConvertDataTableToJSON(ds.Tables[0]);
