...
{
    public partial class ErrorLog000 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "ERROR_NO" };
        ...
        private void SetPageInit()
        {
            ...
            sParam.Add("MENU_ID",       "WEB_00070");
            sParam.Add("USER_ID",       bp.g_userid.ToString());
            

            sParam.Add("CUR_MENU_ID",   "WEB_00070");
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "ERROR_NO", "MENU_NM", "QUERY_ID", "ERROR_LOG", "REGIST_DATE", "KEY_HID" };
        ...
        public void GetData()
        {
            ...
            strDBName = "GPDB";
            strQueryID = "ErrorLogData.Get_ErrorLogList";

            FW.Data.Parameters param = new FW.Data.Parameters();
            param.Add("SDATE",      txtFromDt.Text.Replace("-", ""));
            param.Add("EDATE",      txtToDt.Text.Replace("-", ""));
            param.Add("MENU_ID",    ddlMenu.SelectedValue);

            Biz.SystemManagement.ErrorLogMgt biz = new Biz.SystemManagement.ErrorLogMgt();
            
            // 비지니스 메서드 호출
            ds = biz.GetErrorLogList(strDBName, strQueryID, param);
