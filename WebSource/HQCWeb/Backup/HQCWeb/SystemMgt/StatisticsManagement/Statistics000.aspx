    ...
    <script type="text/javascript">
        ...
        function fn_Search() {
            ...
            if (!bChk) {
                ...
                if (vRbCon == "RB02") {
                    if ($("#MainContent_txtSearchText").val() == "") {
                        alert("사용자명을 입력하세요.");
                        $("#MainContent_txtSearchText").focus();
                        return false;
                    }
                }
                        ...
                        <tr>
                            <td>
                                <div class="toolbar">
                                    ...
                                    <input type="button" value="Set" id="btnSet" onclick="getCol('WEB_00120'); return false;" style="display:none; margin-top:2px;" />
                                </div>
                            </td>
                        </tr>
                    </table>--%>
