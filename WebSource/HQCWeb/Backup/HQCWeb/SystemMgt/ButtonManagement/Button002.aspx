<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Button002.aspx.cs" Inherits="HQCWeb.SystemMgt.ButtonManagement.Button002" %>
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lbGetButtonID" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
