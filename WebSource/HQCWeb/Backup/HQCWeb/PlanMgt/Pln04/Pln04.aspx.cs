        ...
        private void SetPageInit()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "PLAN_DATE", "TRANS_FLG", "SHIP_NO", "CAR_NM_KOR", "PLAN_QTY", "DELIVERY_QTY", "PART_NO", "PART_DESC", "S_STORAGE_NM", "STORAGE_NM", "CUSTOMER_NM", "EVENT_FLG_NM", "ORDER_NO", "STATUS_FLG", "EVENT_FLG", "KEY_HID" };
