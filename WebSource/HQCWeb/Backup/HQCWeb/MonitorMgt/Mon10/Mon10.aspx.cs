...
namespace HQCWeb.MonitorMgt.Mon10
{
    public partial class Mon10 : System.Web.UI.Page
    {
        ...
        // 그리드 키값 정의
        public string[] strKeyColumn = new string[] { "PLANT_CD", "SHOP_CD", "LINE_CD", "SERIAL_NO" };
        ...
        private void SetPageInit()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "RPT_DATE", "CAR_NM_KOR", "PART_NO", "SERIAL_NO", "COMPLETE_NO", "PROD_DT", "SHOP_CD", "LINE_CD", "CAR_TYPE"
, "KEY_HID" };
        ...
        public void GetData()
        {
            ...
            sParam.Add("PROD_DT", txtFromDt.Text.Replace("-",""));
