<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Popup.Master" AutoEventWireup="true" CodeBehind="Qua11_p01.aspx.cs" Inherits="HQCWeb.QualityMgt.Qua11.Qua11_p01" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PopupContent" runat="server">
    ...
    <div class="popup_wrap">
        <!--// Title -->
        <div class="title">
            <h1><asp:Label ID="lbTitle" runat="server">Qua11</asp:Label> - <asp:Label ID="lbWorkName" runat="server"></asp:Label></h1>
        ...
        <div class="box">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <asp:FileUpload ID="fudFilePath" runat="server" />
                    </td>
                </tr>
            </table>
            <!-- Table //-->
    ...
    <!-- POPUP //-->
    <div id="realgrid" style="display:none;"></div>
</asp:Content>
