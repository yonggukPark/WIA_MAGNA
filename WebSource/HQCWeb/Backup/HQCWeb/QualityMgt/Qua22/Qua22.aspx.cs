        ...
        private void SetPageInit()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        arrColumn = new string[] { "PLANT_CD", "SERIAL_NO", "PROD_DT", "REINPUT_PROD_DT", "LOG_SEQ", "NGCD", "SHOP_CD", "LINE_CD", "STN_CD", "REINPUT_STN_CD", "STATE", "CAUSE1", "CAUSE2", "CAUSE3", "CAUSE4", "CAUSE5", "MEMO", "RPT_DATE", "REINPUT_RPT_DATE", "RPT_USER", "KEY_HID" };
